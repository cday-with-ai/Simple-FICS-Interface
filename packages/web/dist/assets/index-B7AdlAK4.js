...
`,Qa={K:"wK",Q:"wQ",R:"wR",B:"wB",N:"wN",P:"wP",k:"bK",q:"bQ",r:"bR",b:"bB",n:"bN",p:"bP"},Me=({piece:e,size:t,isDragging:n=!1,style:r})=>{const o=Qa[e];if(!o)return null;const i=`/pieces/cburnett/${o}.svg`;return s.jsx(Ja,{className:"chess-piece",src:i,alt:o,$isDragging:n,draggable:!1,style:r})};Me.displayName="ChessPiece";const Za=m.div`
...
`,Bt=({name:e,className:t,style:n})=>{const[r,o]=h.useState(null),i=a=>{a.preventDefault(),a.stopPropagation(),o({x:a.clientX,y:a.clientY})};return s.jsxs(s.Fragment,{children:[s.jsx(mc,{className:t,style:n,onClick:i,children:e}),r&&s.jsx(Eo,{playerName:e,position:r,onClose:()=>o(null)})]})};Bt.displayName="PlayerName";const fc=m.div`
  display: flex;
  flex-direction: column;
...
`;const Ze=Z(({name:e,rating:t,time:n,isActive:r,isWhite:o,orientation:i="horizontal",hideClockInCard:a=!1,onlyInfo:d=!1,compact:c=!1})=>{const l=s.jsxs(s.Fragment,{children:[s.jsx(gc,{children:s.jsxs(yc,{children:[s.jsx(xc,{children:s.jsx(Bt,{name:e})}),s.jsx(bc,{children:t})]})}),!a&&!d&&s.jsx(ut,{time:n,isActive:r,showTenths:n<10,lowTimeThreshold:30,size:i==="horizontal"?"medium":"small"})]});return d?l:s.jsx(fc,{$isActive:r,$orientation:i,$compact:c,children:l})});Ze.displayName="PlayerCard";const $c=m.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  background-color: ${e=>e.theme.colors.surface};
...
`,Wt=Z(({moves:e,currentMoveIndex:t,onMoveClick:n,onNavigate:r,showHeader:o=!0,extraControls:i,className:a,disableAutoScroll:d=!1})=>{const c=h.useRef(null);h.useEffect(()=>{if(!d&&c.current&&t!==void 0){const p=c.current.querySelector(`[data-move-index="${t}"]`);p&&p.scrollIntoView({behavior:"smooth",block:"nearest"})}},[t,d]);const l=()=>{const p=[];for(let u=0;u<e.length;u+=2){const f=Math.floor(u/2)+1,g=e[u],v=e[u+1];p.push(s.jsxs(rr,{children:[s.jsxs(wc,{children:[f,"."]}),s.jsx(or,{$isCurrentMove:t===u,onClick:()=>n?.(u),"data-move-index":u,children:rn(g.san)}),v&&s.jsx(or,{$isCurrentMove:t===u+1,onClick:()=>n?.(u+1),"data-move-index":u+1,children:rn(v.san)})]},u))}return p};return s.jsxs($c,{className:a,children:[o?s.jsx(Zt,{children:s.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[s.jsx("span",{children:"Moves"}),s.jsxs(en,{children:[s.jsx(ue,{onClick:()=>r?.("first"),title:"First move",children:"⏮"}),s.jsx(ue,{onClick:()=>r?.("prev"),title:"Previous move",children:"◀"}),s.jsx(ue,{onClick:()=>r?.("next"),title:"Next move",children:"▶"}),s.jsx(ue,{onClick:()=>r?.("last"),title:"Last move",children:"⏭"})]})]})})}):i?s.jsxs(Zt,{children:[i,s.jsxs(en,{children:[s.jsx(ue,{onClick:()=>r?.("first"),title:"First move",children:"⏮"}),s.jsx(ue,{onClick:()=>r?.("prev"),title:"Previous move",children:"◀"}),s.jsx(ue,{onClick:()=>r?.("next"),title:"Next move",children:"▶"}),s.jsx(ue,{onClick:()=>r?.("last"),title:"Last move",children:"⏭"})]})]}):s.jsx(Zt,{children:s.jsxs(en,{children:[s.jsx(ue,{onClick:()=>r?.("first"),title:"First move",children:"⏮"}),s.jsx(ue,{onClick:()=>r?.("prev"),title:"Previous move",children:"◀"}),s.jsx(ue,{onClick:()=>r?.("next"),title:"Next move",children:"▶"}),s.jsx(ue,{onClick:()=>r?.("last"),title:"Last move",children:"⏭"})]})}),s.jsx(vc,{ref:c,children:e.length===0?s.jsx(rr,{children:s.jsx("span",{style:{color:"var(--color-textSecondary)"},children:"No moves yet"})}):l()})]})});Wt.displayName="MoveList";const kc=m(ut)`
    height: 100%;
    flex-shrink: 0;
...
`,et=Z(({player:e,isActive:t,size:n="small",compact:r=!0,variant:o="portrait"})=>{const i=o==="landscape"?Cc:kc;return s.jsx(i,{time:e.time,isActive:t,showTenths:e.time<10,lowTimeThreshold:30,size:n,compact:r})});et.displayName="ObservableClock";const Sc=m.div`
  position: relative;
  display: inline-block;
`,Pc=m.button`
...
`,cr=m.div`
  ...
  transition: all 0.3s ease;
`,Lo=Z(({evaluation:e,percent:t,orientation:n="vertical",className:r})=>{const i=Mt().isBottomPlayerWinning;let a,d,c;if(t===50)a=47,d=6,c=47;else if(t>50){const p=t-50;a=50-p,d=p,c=50}else{const p=50-t;a=50,d=p,c=50-p}const l=t===50?"#FFC107":i?"#2E7D32":"#C62828";if(n==="vertical"){const p=t<80;return s.jsxs(ir,{$orientation:n,className:r,children:[s.jsx(sr,{$orientation:n,children:e}),s.jsx(Mc,{$isLight:p,children:e}),s.jsxs(ar,{$orientation:n,children:[s.jsx(ft,{style:{height:`${a}%`}}),s.jsx(cr,{$color:l,style:{height:`${d}%`}}),s.jsx(ft,{style:{height:`${c}%`}})]})]})}else return s.jsxs(ir,{$orientation:n,className:r,children:[s.jsx(sr,{$orientation:n,children:e}),s.jsxs(ar,{$orientation:n,children:[s.jsx(ft,{style:{width:`${c}%`}}),s.jsx(cr,{$color:l,style:{width:`${d}%`}}),s.jsx(ft,{style:{width:`${a}%`}})]})]})});Lo.displayName="EvaluationBar";const Lc=m.div`
  display: flex;
  align-items: center;
...
`,yn=Z(({orientation:e="vertical",boardSize:t})=>{const n=Mt();return s.jsx(Lc,{$orientation:e,$boardSize:t,children:s.jsx(Lo,{evaluation:n.evaluation,percent:n.evaluationPercent,orientation:e})})}),xn=Z(({className:e})=>{const t=Mt();return s.jsxs(zc,{className:e,children:[s.jsxs("div",{className:"depth",children:["Depth ",t.depth||0]}),s.jsx("div",{className:"line",children:t.principalVariation||(t.currentLine?t.currentLine.pv.join(" "):null)||"Calculating..."})]})});yn.displayName="AnalysisDisplay";xn.displayName="AnalysisInfoDisplay";const Tc=m.div`
  display: ${e=>e.$isOpen?"flex":"none"};
  position: fixed;
  top: 0;
  left: 0;
...
`,Bc=m(zo)`
  ...
  cursor: text;
`,To=Z(({isOpen:e,onClose:t})=>{const{gameStore:n}=Ae(),[r,o]=h.useState(""),[i,a]=h.useState(""),d=n.currentPosition||"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",c=h.useCallback(g=>{o(g.target.value),a("")},[]),l=h.useCallback(()=>{try{n.loadPosition(r.trim())?(t(),o(""),a("")):a("Invalid FEN string. Please check the format.")}catch{a("Invalid FEN string. Please check the format.")}},[r,n,t]),p=h.useCallback(g=>{const v=typeof g=="function"?g():g;o(v),a("");try{n.loadPosition(v)?(t(),o("")):a("Failed to load preset position.")}catch{a("Failed to load preset position.")}},[n,t]),u=h.useCallback(g=>{g.key==="Enter"&&r.trim()?l():g.key==="Escape"&&t()},[r,l,t]),f=[{name:"Starting Position",fen:"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1"},{name:"Random Chess960",fen:()=>_o.generateChess960Position()},{name:"Sicilian Dragon",fen:"r1bqkb1r/pp2pp1p/2np1np1/8/3PP3/2N2N2/PPP2PPP/R1BQKB1R w KQkq - 0 7"}];return e?s.jsx(Tc,{$isOpen:e,onClick:t,children:s.jsxs(Ic,{onClick:g=>g.stopPropagation(),children:[s.jsx(Nc,{children:"Set Position from FEN"}),s.jsx(Dc,{children:"Enter a FEN (Forsyth-Edwards Notation) string to set up a custom position."}),s.jsxs(dr,{children:[s.jsx(ur,{children:"Current position:"}),s.jsx(Bc,{type:"text",value:d,readOnly:!0,onClick:g=>g.currentTarget.select()})]}),s.jsxs(dr,{children:[s.jsx(ur,{children:"Preset position:"}),f.map(g=>s.jsx(Fc,{onClick:()=>p(g.fen),children:g.name},g.name))]}),s.jsx(zo,{type:"text",value:r,onChange:c,onKeyDown:u,placeholder:"e.g., rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",autoFocus:!0}),i&&s.jsx(Ac,{children:i}),s.jsxs(Oc,{children:[s.jsx(lr,{onClick:t,children:"Cancel"}),s.jsx(lr,{$variant:"primary",onClick:l,disabled:!r.trim(),children:"Set Position"})]})]})}):null});To.displayName="FENDialog";const Wc=m.div`
  display: flex;
...
`,hr=m.button`
  ...
  `}
`,Jc=({isOpen:e,title:t,message:n,confirmText:r="Confirm",cancelText:o="Cancel",onConfirm:i,onCancel:a})=>s.jsx(qc,{$isOpen:e,onClick:a,children:s.jsxs(Yc,{onClick:d=>d.stopPropagation(),children:[s.jsx(Vc,{children:t}),s.jsx(Kc,{children:n}),s.jsxs(Xc,{children:[s.jsx(hr,{$variant:"secondary",onClick:a,children:o}),s.jsx(hr,{$variant:"primary",onClick:i,children:r})]})]})}),Qc=m.div`
    width: 100%;
    height: 100%;
...
`,Yl=m.div`
  ...
  padding-top: 0;
  padding-bottom: 0;
`,Bo=Z(({className:e,compact:t=!1})=>{const{chatStore:n,ficsStore:r}=Ae(),[o,i]=h.useState(""),[a,d]=h.useState(!1),[c,l]=h.useState(null);re.useEffect(()=>{!r.connected&&!r.connecting&&(console.log("Auto-connecting to FICS..."),r.connect())},[r]),re.useEffect(()=>{r.error&&n.addMessage("console",{channel:"console",sender:"System",content:`Error: ${r.error}`,timestamp:new Date,type:"system"})},[r.error,n]);const p=f=>{if(console.log("handleSendMessage called with:",f,"Length:",f.length),!!f.trim()){if(n.addToHistory(f),f==="/help"||f==="\\help"){n.addMessage("console",{channel:"console",sender:"You",content:f,timestamp:new Date,type:"message"}),n.addMessage("console",{channel:"console",sender:"System",content:`FICS Commands:
...
`,ed=()=>s.jsx(Uo,{children:s.jsxs(Na,{children:[s.jsx(Zl,{}),s.jsx(ys,{children:s.jsx(Yi,{children:s.jsx(Wr,{path:"/",element:s.jsx(Ua,{children:s.jsx(Wo,{})})})})})]})}),Ho=document.getElementById("root");if(!Ho)throw new Error("Root element not found");const td=Er(Ho);td.render(s.jsx(ed,{}));
