...
`,qc={K:"wK",Q:"wQ",R:"wR",B:"wB",N:"wN",P:"wP",k:"bK",q:"bQ",r:"bR",b:"bB",n:"bN",p:"bP"},De=K(({piece:e,size:t,isDragging:r=!1,style:n})=>{const o=Ne(),s=qc[e];if(!s)return null;const h=`/pieces/${o.preferences.pieceSet}/${s}.svg`;return i.jsx(Yc,{className:"chess-piece",src:h,alt:s,$isDragging:r,draggable:!1,style:n,"data-settings":"pieces"})});De.displayName="ChessPiece";const Vc=m.div`
...
`,Wo=({isOpen:e,color:t,onSelect:r,onCancel:n,position:o})=>{if(!o)return null;const s=["Q","R","B","N"],a=h=>t==="white"?h:h.toLowerCase();return i.jsx(Vc,{$isOpen:e,onClick:n,children:i.jsx(Kc,{$x:o.x,$y:o.y,onClick:h=>h.stopPropagation(),children:s.map(h=>i.jsx(Xc,{onClick:()=>r(h.toLowerCase()),children:i.jsx(De,{piece:a(h),size:50})},h))})})};Wo.displayName="PromotionDialog";const Qc=m.div`
  width: ${e=>e.$size}px;
  height: ${e=>e.$size}px;
  position: relative;
...
`,it=({name:e,className:t,style:r,onClick:n})=>{const[o,s]=f.useState(null),a=h=>{h.preventDefault(),h.stopPropagation(),n&&n(),s({x:h.clientX,y:h.clientY})};return i.jsxs(i.Fragment,{children:[i.jsx(hl,{className:t,style:r,onClick:a,children:e}),o&&i.jsx(_o,{playerName:e,position:o,onClose:()=>s(null)})]})};it.displayName="PlayerName";const pl=m.div`
  display: flex;
  flex-direction: column;
...
`;const ut=K(({name:e,rating:t,time:r,isActive:n,isWhite:o,orientation:s="horizontal",hideClockInCard:a=!1,onlyInfo:h=!1,compact:c=!1})=>{const d=i.jsxs(i.Fragment,{children:[i.jsx(ml,{children:i.jsxs(fl,{children:[i.jsx(gl,{children:i.jsx(it,{name:e})}),i.jsx(xl,{children:t})]})}),!a&&!h&&i.jsx(kt,{time:r,isActive:n,showTenths:r<10,lowTimeThreshold:30,size:s==="horizontal"?"medium":"small"})]});return h?d:i.jsx(pl,{$isActive:n,$orientation:s,$compact:c,children:d})});ut.displayName="PlayerCard";const yl=m.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  background-color: ${e=>e.theme.colors.surface};
...
`,Hr=K(({color:e,size:t="small"})=>{const r=Ne(),[n,o]=f.useState(!1),s=f.useRef(null),a=["Q","R","B","N"],h=r.preferences.autoPromotionPiece,c=p=>e==="white"?p:p.toLowerCase();f.useEffect(()=>{const p=g=>{s.current&&!s.current.contains(g.target)&&o(!1)};if(n)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[n]);const d=p=>{r.updatePreference("autoPromotionPiece",p),o(!1)},l=t==="small"?28:36;return i.jsxs(kl,{ref:s,children:[i.jsx(Sl,{$size:t,onClick:()=>o(!n),title:"Select promotion piece",children:i.jsx(De,{piece:c(h),size:l})}),i.jsx(Cl,{$isOpen:n,children:a.map(p=>i.jsx(jl,{$size:t,onClick:()=>d(p),title:`Promote to ${p==="Q"?"Queen":p==="R"?"Rook":p==="B"?"Bishop":"Knight"}`,children:i.jsx(De,{piece:c(p),size:l})},p))})]})});Hr.displayName="PromotionPieceSelector";const Pl=m.div`
  display: flex;
  flex-wrap: wrap;
  gap: ${e=>e.theme.spacing[1]};
  padding: ${e=>e.theme.spacing[2]};
...
`,Cn=m.div`
  ...
  transition: all 0.3s ease;
`,Uo=K(({evaluation:e,percent:t,orientation:r="vertical",className:n})=>{const s=Yt().isBottomPlayerWinning;let a,h,c;if(t===50)a=47,h=6,c=47;else if(t>50){const l=t-50;a=50-l,h=l,c=50}else{const l=50-t;a=50,h=l,c=50-l}const d=t===50?"#FFC107":s?"#2E7D32":"#C62828";if(r==="vertical"){const l=t<20;return i.jsxs(wn,{$orientation:r,className:n,children:[i.jsx(kn,{$orientation:r,children:e}),i.jsx(Rl,{$needsDarkText:l,children:e}),i.jsxs(Sn,{$orientation:r,children:[i.jsx(Mt,{style:{height:`${a}%`}}),i.jsx(Cn,{$color:d,style:{height:`${h}%`}}),i.jsx(Mt,{style:{height:`${c}%`}})]})]})}else return i.jsxs(wn,{$orientation:r,className:n,children:[i.jsx(kn,{$orientation:r,children:e}),i.jsxs(Sn,{$orientation:r,children:[i.jsx(Mt,{style:{width:`${c}%`}}),i.jsx(Cn,{$color:d,style:{width:`${h}%`}}),i.jsx(Mt,{style:{width:`${a}%`}})]})]})});Uo.displayName="EvaluationBar";const Ml=m.div`
  display: flex;
  align-items: center;
...
`,_l=m(De)`
  width: 100%;
  height: 100%;
`,pt=K(({orientation:e="horizontal",isWhitePieces:t=!0,className:r,boardSize:n,onPieceClick:o})=>{const{gameStore:s}=Ee(),a=f.useMemo(()=>{if(s.currentGame?.variant==="crazyhouse")return(t?s.whiteHoldings:s.blackHoldings).toLowerCase().split("");{const p=s.capturedPieces;return t?p.white:p.black}},[s.currentGame?.variant,s.whiteHoldings,s.blackHoldings,s.capturedPieces,t]),h=f.useMemo(()=>{const l={};return a.forEach(p=>{l[p]=(l[p]||0)+1}),l},[a]),c=["p","n","b","r","q"],d=n?n/8:32;return i.jsx(Fl,{$orientation:e,$size:d,className:r,children:i.jsx(Bl,{$orientation:e,children:c.map(l=>{const p=h[l]||0,g=t?l.toUpperCase():l;return i.jsx(Wl,{$size:d,onClick:p>0&&o?()=>o(g):void 0,style:{cursor:p>0&&o?"pointer":"default"},children:p>0&&i.jsxs(i.Fragment,{children:[i.jsx(_l,{piece:g,size:d}),p>1&&i.jsx(Hl,{children:p})]})},l)})})})});pt.displayName="CapturedPieces";const Gl=m.div`
  display: ${e=>e.$isOpen?"flex":"none"};
  position: fixed;
  top: 0;
  left: 0;
...
`,Mn=m.button`
  ...
  `}
`,Kl=({isOpen:e,title:t,message:r,confirmText:n="Confirm",cancelText:o="Cancel",onConfirm:s,onCancel:a})=>i.jsx(Gl,{$isOpen:e,onClick:a,children:i.jsxs(Ul,{onClick:h=>h.stopPropagation(),children:[i.jsx(Yl,{children:t}),i.jsx(ql,{children:r}),i.jsxs(Vl,{children:[i.jsx(Mn,{$variant:"secondary",onClick:a,children:o}),i.jsx(Mn,{$variant:"primary",onClick:s,children:n})]})]})}),Xl=m.div`
    width: 100%;
    height: 100%;
...
`,Cd=m.span`
  font-size: 12px;
  opacity: 0.7;
`,Qo=K(()=>{const{chatStore:e}=Ee(),t=e.sortedTabs,[r,n]=ie.useState(null),[o,s]=ie.useState(null),a=(p,g)=>{n(g),p.dataTransfer.effectAllowed="move"},h=(p,g)=>{p.preventDefault(),p.dataTransfer.dropEffect="move",s(g)},c=()=>{s(null)},d=(p,g)=>{p.preventDefault(),r&&r!==g&&e.reorderTabs(r,g),n(null),s(null)},l=()=>{n(null),s(null)};return i.jsx($d,{children:t.map(p=>i.jsxs(vd,{$active:p.id===e.activeTabId,$hasUnread:p.unreadCount>0,$dragging:p.id===r,$dragOver:p.id===o,draggable:!0,onDragStart:g=>a(g,p.id),onDragOver:g=>h(g,p.id),onDragLeave:c,onDrop:g=>d(g,p.id),onDragEnd:l,onClick:()=>e.setActiveTab(p.id),children:[p.type!=="console"&&i.jsx(Cd,{$type:p.type}),i.jsx(wd,{children:p.type==="channel"?`(${p.name})`:p.name}),p.unreadCount>0&&i.jsx(kd,{children:p.unreadCount>99?"99+":p.unreadCount}),p.id!=="console"&&i.jsx(Sd,{onClick:g=>{g.stopPropagation(),e.closeTab(p.id)},title:"Close tab",children:"×"})]},p.id))})});Qo.displayName="ChatTabs";function jd(e,t=10){return e.scrollHeight<=e.clientHeight+1||e.scrollTop===0&&e.scrollHeight<=e.clientHeight+t?!0:e.scrollHeight-e.scrollTop<=e.clientHeight+t}function Pd(e){e.scrollTop=e.scrollHeight}function Rd(e,t=10){jd(e,t)&&Pd(e)}class Le{canRender(t){return t.metadata?.consoleType===this.type||t.type===this.type}}class O{static{this.renderers=new Map}static register(t){this.renderers.set(t.type,t)}static getRenderer(t){if(t.metadata?.consoleType){const n=this.renderers.get(t.metadata.consoleType);if(n)return n}const r=this.renderers.get(t.type);if(r)return r;for(const[,n]of this.renderers)if(n.canRender(t))return n;return null}static getAllRenderers(){return Array.from(this.renderers.values())}}const _e=m.div`
  display: flex;
...
`,Zo=K(({onMessageHover:e})=>{const{chatStore:t,ficsStore:r,preferencesStore:n}=Ee(),o=f.useRef(null),s=t.activeTab,a=s?.messages||[],h=r.username||"You",c=l=>{r.sendCommand(l)};if(f.useEffect(()=>{if(o.current&&a.length>0){const l=o.current,p=setTimeout(()=>{s?.type==="console"?l.scrollTop=l.scrollHeight:Rd(l,50)},50);return()=>clearTimeout(p)}},[a.length,a[a.length-1]?.id]),f.useEffect(()=>{if(o.current&&a.length>0){const l=o.current;requestAnimationFrame(()=>{l.scrollTop=l.scrollHeight})}},[s?.id]),!s)return i.jsx(Et,{children:i.jsx(zt,{className:"chat-messages-container",children:i.jsx(On,{children:"No active chat"})})});if(a.length===0)return i.jsx(Et,{children:i.jsx(zt,{className:"chat-messages-container",children:i.jsx(On,{children:s.type==="channel"?`No messages in (${s.name}) yet`:s.type==="private"?`No messages with ${s.name} yet`:"Connecting to freechess.org..."})})});const d=[];return a.forEach((l,p)=>{const g=p>0?a[p-1]:null,u=g?new Date(l.timestamp).getTime()-new Date(g.timestamp).getTime():1/0;g&&g.sender===l.sender&&g.type===l.type&&u<6e4?d[d.length-1].messages.push(l):d.push({sender:l.sender,timestamp:new Date(l.timestamp),messages:[l]})}),s.type==="console"?i.jsx(Et,{children:i.jsx(zt,{ref:o,className:"chat-messages-container",children:a.map(l=>i.jsx(Lt,{children:i.jsx(mt,{message:l,currentUsername:h,onCommandClick:c,onHover:e})},l.id))})}):i.jsx(Et,{children:i.jsx(zt,{ref:o,className:"chat-messages-container",children:d.map((l,p)=>l.messages[0].type==="system"?i.jsx(hu,{children:l.messages.map(u=>i.jsx(Lt,{children:i.jsx(mt,{message:u,currentUsername:h,onCommandClick:c,onHover:e})},u.id))},p):i.jsx(uu,{children:l.messages.map((u,y)=>{if(y===0)return i.jsx(Lt,{children:i.jsx(mt,{message:u,currentUsername:h,onCommandClick:c,onHover:e})},u.id);{const b={...u,sender:"",metadata:{...u.metadata,isGroupedMessage:!0}};return i.jsx(Lt,{children:i.jsx(mt,{message:b,currentUsername:h,onCommandClick:c,onHover:e})},u.id)}})},p))})})});Zo.displayName="ChatMessages";const pu=m.div`
  display: flex;
  gap: ${e=>e.theme.spacing[2]};
  padding: ${e=>e.theme.spacing[2]};
  padding-top: ${e=>e.theme.spacing[1]};
...
`,vu=m.div`
  ...
  padding-top: 0;
  padding-bottom: 0;
`,ti=K(({className:e,compact:t=!1})=>{const{chatStore:r,ficsStore:n,preferencesStore:o}=Ee(),[s,a]=f.useState(""),[h,c]=f.useState(!1),[d,l]=f.useState(null);ie.useEffect(()=>{!n.connected&&!n.connecting&&(console.log("Auto-connecting to FICS..."),n.connect())},[n]),ie.useEffect(()=>{n.error&&r.addMessage("console",{channel:"console",sender:"System",content:`Error: ${n.error}`,timestamp:new Date,type:"system"})},[n.error,r]);const p=u=>{if(console.log("handleSendMessage called with:",u,"Length:",u.length),!!u.trim()){if(r.addToHistory(u),u==="/help"||u==="\\help"){r.addMessage("console",{channel:"console",sender:"You",content:u,timestamp:new Date,type:"message"}),r.addMessage("console",{channel:"console",sender:"System",content:`FICS Commands:
...
`,ri=K(()=>{const{preferencesStore:e}=Ee(),{viewMode:t,autoViewMode:r}=e.preferences,n=Oe(),o=No(),s=Oo(),a=ic(),[h,c]=f.useState(600),[d,l]=f.useState(!1),p=f.useRef(!1);f.useEffect(()=>{!p.current&&r&&(p.current=!0,e.updatePreference("viewMode",a.viewMode),e.updatePreference("chessOrientation",a.orientation),e.updatePreference("autoViewMode",!1))},[r,a,e]),f.useEffect(()=>{o.includes(t)||e.updatePreference("viewMode","chess-only")},[o,t,e]),f.useEffect(()=>{const $=e.preferences.chessOrientation;s.includes($)||e.updatePreference("chessOrientation","portrait")},[s,e]);const g=$=>{$.preventDefault(),l(!0)};f.useEffect(()=>{if(!d)return;const $=k=>{const S=window.innerWidth-k.clientX;c(Math.max(300,Math.min(600,S))),window.dispatchEvent(new Event("resize"))},x=()=>{l(!1)};return document.addEventListener("mousemove",$),document.addEventListener("mouseup",x),()=>{document.removeEventListener("mousemove",$),document.removeEventListener("mouseup",x)}},[d]);const u=t==="chess-only"||t==="chess-and-chat",y=t==="chat-only"||t==="chess-and-chat",b=t==="chess-and-chat"&&!n.isMobile;return i.jsxs(wu,{children:[i.jsx(Bo,{}),i.jsxs(ku,{children:[i.jsx(Su,{$isVisible:u,children:i.jsx(Xo,{hasChat:y,chatWidth:y&&!n.isMobile?h:0})}),b&&i.jsx(ju,{$isVisible:!0,onMouseDown:g,style:{cursor:d?"col-resize":"ew-resize"}}),i.jsx(Cu,{$isVisible:y,$fullWidth:t==="chat-only",style:{width:t==="chat-only"?void 0:y&&!n.isMobile?`${h}px`:void 0},children:i.jsx(ti,{})})]})]})});ri.displayName="AppLayout";const Pu=Va`
    * {
        margin: 0;
        padding: 0;
        box-sizing: border-box;
