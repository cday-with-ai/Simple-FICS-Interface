...
`,Os={K:"wK",Q:"wQ",R:"wR",B:"wB",N:"wN",P:"wP",k:"bK",q:"bQ",r:"bR",b:"bB",n:"bN",p:"bP"},Ce=({piece:e,size:t,isDragging:r=!1,style:n})=>{const o=Os[e];if(!o)return null;const i=`/pieces/cburnett/${o}.svg`;return a.jsx(Fs,{className:"chess-piece",src:i,alt:o,$isDragging:r,draggable:!1,style:n})};Ce.displayName="ChessPiece";const Bs=f.div`
...
`,qr=f.div`
  ...
  `:`
    ...
    left: 1px;
  `}
`,qs=f.div.attrs(e=>({style:{transform:`translate(calc(${e.$x}px - 50%), calc(${e.$y}px - 50%))`,width:`${e.$size}px`,height:`${e.$size}px`}}))`
  position: fixed;
  left: 0;
  top: 0;
  pointer-events: none;
...
`,Ys=f.div.attrs(e=>({style:{transform:`translate(
  ...
  justify-content: center;
  will-change: transform;
`,Ie=["a","b","c","d","e","f","g","h"],Me=["8","7","6","5","4","3","2","1"];function Vs(e,t){return(e+t)%2===0}function Ks(e,t,r){const n=r?Ie[7-e]:Ie[e],o=r?Me[7-t]:Me[t];return`${n}${o}`}function Xs(e){const t=new Map,[r]=e.split(" ");return r.split("/").forEach((o,i)=>{let s=0;for(const d of o)if(d>="1"&&d<="8")s+=parseInt(d);else{const c=`${Ie[s]}${Me[i]}`;t.set(c,d),s++}}),t}const er=Y(({position:e,size:t,flipped:r=!1,showCoordinates:n=!0,onMove:o,highlightedSquares:i=new Set,lastMove:s,interactive:d=!0,onSizeCalculated:c})=>{Tt();const l=Oe(),u=nr(),p=h.useRef(null),[m,g]=h.useState(t||200),[y,b]=h.useState(null),[$,x]=h.useState(new Set),[v,k]=h.useState(null),[j,L]=h.useState([]),E=h.useRef(),[C,F]=h.useState(null),A=h.useMemo(()=>Xs(e),[e]),K=h.useRef(new Map),le=h.useCallback((w,R)=>{const P=Ie.indexOf(w[0]),S=Me.indexOf(w[1]),z=R/8,M=r?(7-P)*z:P*z,G=r?(7-S)*z:S*z;return{x:M,y:G}},[r]),X=h.useCallback((w,R,P)=>{const S=w.toLowerCase()==="p",z=P[1];return S&&(z==="8"||z==="1")},[]),de=h.useCallback(w=>{w.preventDefault(),u.isPlaying&&u.clearPremove()},[u]);h.useEffect(()=>{if(t){g(t);return}const w=()=>{if(!p.current)return;const M=p.current.parentElement;if(!M)return;const{width:G,height:Q}=M.getBoundingClientRect();p.current.getBoundingClientRect();const J=16,I=G-J,H=Q-J,B=Math.floor(Math.min(I,H)),W=Math.max(100,Math.floor(B/8)*8);W!==m&&(g(W),c?.(W))},R=setTimeout(w,50);w();let P;const S=()=>{clearTimeout(P),P=setTimeout(w,100)};window.addEventListener("resize",S);let z=null;return p.current&&p.current.parentElement&&(z=new ResizeObserver(()=>{S()}),z.observe(p.current.parentElement)),()=>{window.removeEventListener("resize",S),clearTimeout(P),clearTimeout(R),z&&z.disconnect()}},[t,m]);const te=m/8,se=h.useMemo(()=>{if(!l.preferences.animateMoves)return!1;if(u.isPlaying&&l.preferences.disableAnimationLowTime){const w=u.currentGame,R=u.playingColor;if(w&&R&&(R==="white"?w.white.time:w.black.time)<10)return!1}return!0},[l.preferences.animateMoves,l.preferences.disableAnimationLowTime,u.isPlaying,u.currentGame,u.playingColor]);h.useEffect(()=>{if(!se){K.current=new Map(A);return}const w=K.current,R=[];w.forEach((P,S)=>{A.has(S)||A.forEach((z,M)=>{z===P&&!w.has(M)&&s&&s.from===S&&s.to===M&&R.push({piece:P,from:S,to:M,startTime:Date.now()})})}),R.length>0&&L(P=>[...P,...R]),K.current=new Map(A)},[A,s,se]),h.useEffect(()=>{if(j.length===0)return;const w=()=>{const R=Date.now(),P=l.preferences.animationDuration;L(S=>{const z=S.filter(M=>R-M.startTime<P);return z.length>0&&(E.current=requestAnimationFrame(w)),z})};return E.current=requestAnimationFrame(w),()=>{E.current&&cancelAnimationFrame(E.current)}},[j.length,l.preferences.animationDuration]);const re=h.useCallback((w,R)=>{if(!d)return;const P=A.get(w);if(y)if($.has(w)||w!==y){const S=A.get(y);if(S&&X(S,y,w)){const z=S===S.toUpperCase()?"white":"black";if(u.isPlaying){const M=l.preferences.autoPromotionPiece;u.isMyTurn?o?.(y,w,M):u.setPremove(y,w,M)}else{const M=R?.currentTarget.getBoundingClientRect();F({from:y,to:w,color:z,position:M?{x:M.left+M.width/2,y:M.top+M.height/2}:{x:window.innerWidth/2,y:window.innerHeight/2}})}}else u.isPlaying&&!u.isMyTurn?u.setPremove(y,w):o?.(y,w);b(null),x(new Set)}else b(null),x(new Set);else P&&(b(w),x(new Set))},[y,$,A,o,d,X,u.isPlaying,u.isMyTurn,l.preferences.autoPromotionPiece,u]),ge=h.useCallback((w,R,P)=>{if(!d)return;w.preventDefault(),b(R);const S=w.currentTarget.getBoundingClientRect(),z=S.width,M=S.left+S.width/2,G=S.top+S.height/2,Q=w.clientX-M,J=w.clientY-G;k({piece:P,from:R,x:M,y:G,size:z});const I=B=>{k(W=>W?{...W,x:B.clientX-Q,y:B.clientY-J}:null)},H=B=>{const Z=document.elementsFromPoint(B.clientX,B.clientY).find(Lt=>Lt.getAttribute("data-square"))?.getAttribute("data-square");if(Z&&Z!==R)if(X(P,R,Z)){const Lt=P===P.toUpperCase()?"white":"black";if(u.isPlaying){const $r=l.preferences.autoPromotionPiece;u.isMyTurn?o?.(R,Z,$r):u.setPremove(R,Z,$r)}else F({from:R,to:Z,color:Lt,position:{x:B.clientX,y:B.clientY}})}else u.isPlaying&&!u.isMyTurn?u.setPremove(R,Z):o?.(R,Z);k(null),b(null),x(new Set),document.removeEventListener("mousemove",I),document.removeEventListener("mouseup",H)};document.addEventListener("mousemove",I),document.addEventListener("mouseup",H)},[o,d,X,u.isPlaying,u.isMyTurn,l.preferences.autoPromotionPiece,u]),xe=h.useMemo(()=>{const w=[];for(let R=0;R<8;R++)for(let P=0;P<8;P++){const S=Vs(P,R),z=Ks(P,R,r),M=A.get(z),G=i.has(z),Q=s&&(s.from===z||s.to===z),J=y===z,I=$.has(z),H=v?.from===z,B=j.some(Z=>Z.to===z),W=n&&R===7,ne=n&&P===0;w.push(a.jsxs(Us,{"data-square":z,$isLight:S,$isHighlighted:G,$isLastMoveSquare:!!Q,$isSelected:J,$isPossibleMove:I,onClick:Z=>re(z,Z),onMouseDown:Z=>M&&ge(Z,z,M),children:[M&&!H&&!B&&a.jsx(Ce,{piece:M,size:te}),W&&a.jsx(qr,{$type:"file",$isLight:S,children:r?Ie[7-P]:Ie[P]}),ne&&a.jsx(qr,{$type:"rank",$isLight:S,children:r?Me[7-R]:Me[R]})]},z))}return w},[r,n,A,i,s,y,$,v,te,re,ge]);return a.jsxs(a.Fragment,{children:[a.jsxs(_s,{ref:p,$size:m,onContextMenu:de,children:[a.jsx(Gs,{children:xe}),j.map((w,R)=>{const P=le(w.from,m),S=le(w.to,m),z=Date.now()-w.startTime,M=l.preferences.animationDuration,G=Math.min(z/M,1),J=(I=>I<.5?4*I*I*I:1-Math.pow(-2*I+2,3)/2)(G);return a.jsx(Ys,{$fromX:P.x,$fromY:P.y,$toX:S.x,$toY:S.y,$progress:J,$size:te,children:a.jsx(Ce,{piece:w.piece,size:te})},`${w.from}-${w.to}-${w.startTime}`)})]}),v&&a.jsx(a.Fragment,{children:a.jsx(qs,{$x:v.x,$y:v.y,$size:v.size,children:a.jsx(Ce,{piece:v.piece,size:v.size,isDragging:!0})})}),C&&a.jsx(mo,{isOpen:!0,color:C.color,position:C.position,onSelect:w=>{o?.(C.from,C.to,w),F(null)},onCancel:()=>F(null)})]})});er.displayName="ChessBoardWithPieces";const Qs=f.div`
...
`,yr=Y(({color:e,size:t="small"})=>{const r=Oe(),[n,o]=h.useState(!1),i=h.useRef(null),s=["Q","R","B","N"],d=r.preferences.autoPromotionPiece,c=p=>e==="white"?p:p.toLowerCase();h.useEffect(()=>{const p=m=>{i.current&&!i.current.contains(m.target)&&o(!1)};if(n)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[n]);const l=p=>{r.updatePreference("autoPromotionPiece",p),o(!1)},u=t==="small"?28:36;return a.jsxs(hc,{ref:i,children:[a.jsx(pc,{$size:t,onClick:()=>o(!n),title:"Select promotion piece",children:a.jsx(Ce,{piece:c(d),size:u})}),a.jsx(fc,{$isOpen:n,children:s.map(p=>a.jsx(mc,{$size:t,onClick:()=>l(p),title:`Promote to ${p==="Q"?"Queen":p==="R"?"Rook":p==="B"?"Bishop":"Knight"}`,children:a.jsx(Ce,{piece:c(p),size:u})},p))})]})});yr.displayName="PromotionPieceSelector";const gc=f.div`
  display: flex;
  flex-wrap: wrap;
  gap: ${e=>e.theme.spacing[2]};
  padding: ${e=>e.theme.spacing[3]};
...
`,Co=Y(({className:e,hasChat:t=!1})=>{const r=nr(),n=Oe(),o=wt(),i=xn();Tt();const[s,d]=h.useState(!1),[c,l]=h.useState(!1),[u,p]=h.useState(0),[m,g]=h.useState(!1),[y,b]=h.useState(!1),$=n.preferences.chessOrientation==="landscape",x=r.currentPosition||"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",v=h.useMemo(()=>!r.currentGame||r.currentGame.gameId<0?"freestyle":r.isPlaying?"playing":r.isObserving?"observing":r.isExamining?"examining":"observing",[r.currentGame,r.gameRelation]),k=h.useMemo(()=>r.currentGame?.variant==="crazyhouse"?!0:n.preferences.showCapturedPieces,[r.currentGame?.variant,n.preferences.showCapturedPieces]),j=h.useCallback((I,H,B)=>{try{r.makeMove(I,H,B)||console.error("Invalid move:",I,H)}catch(W){console.error("Error making move:",W)}},[r]);h.useMemo(()=>{if(r.currentGameInfo){const{white:I,black:H,timeControl:B,variant:W}=r.currentGameInfo;return`Game ${r.currentGame?.gameId||"?"} • ${W} ${B}`}return"No active game"},[r.currentGameInfo,r.currentGame]);const L=(()=>{const I=r.moveHistory.length;if(I>0){const H=r.moveHistory[I-1],B=Math.ceil(I/2),W=I%2===1,ne=Ht(H.san);return`${B}.${W?"":".."} ${ne}`}return"Starting position"})(),E=r.currentOpening,C=r.currentGame,F=C||r.lastGameState,A=F?.white||{name:"White",rating:1500,time:900},K=F?.black||{name:"Black",rating:1500,time:900},le=!C||C.turn==="w",X=r.shouldShowFlippedBoard,de=X?A:K,te=X?K:A,se=X,re=X?le:!le,ge=h.useCallback(I=>{r.goToMove(I)},[r]);h.useEffect(()=>{o.initialize()},[o]),h.useEffect(()=>{y&&r.isPlaying&&r.currentGame&&i.sendCommand("draw")},[r.moveHistory.length,y,r.isPlaying,i]),h.useEffect(()=>{(!r.currentGame||!r.isPlaying)&&b(!1)},[r.currentGame,r.isPlaying]),h.useEffect(()=>{s&&o.isEngineReady?o.startAnalysis(x):o.stopAnalysis()},[s,x,o]);const xe=h.useCallback(()=>{d(I=>!I)},[]),w=h.useCallback(()=>{l(!0)},[]),R=h.useCallback(()=>{n.updatePreference("boardFlipped",!n.preferences.boardFlipped)},[n]),P=h.useCallback(()=>{r.currentGame&&i.sendCommand(`unobs ${r.currentGame.gameId}`)},[i,r.currentGame]),S=h.useCallback(()=>{i.sendCommand("unexamine")},[i]),z=h.useCallback(()=>{g(!0)},[]),M=h.useCallback(()=>{i.sendCommand("resign"),g(!1)},[i]),G=h.useCallback(()=>{i.sendCommand("draw"),b(!y)},[i,y]),Q=h.useCallback(()=>{i.sendCommand("abort")},[i]),J=()=>a.jsxs(a.Fragment,{children:[a.jsx(nn,{$orientation:"portrait",children:a.jsx(Kc,{children:a.jsxs(Xc,{children:[s&&a.jsx(ol,{$squareSize:u?u/8:0,children:a.jsx(tr,{orientation:"vertical",boardSize:u})}),a.jsxs(Qc,{children:[a.jsx(on,{$size:u?u/8:0}),a.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center"},id:"board-container",children:[a.jsxs(qc,{children:[a.jsxs(an,{children:["Game #",F?.gameId||"?"]}),a.jsx(sn,{children:F?.timeControl||"?"}),a.jsxs(Yc,{children:[v==="playing"&&a.jsxs(a.Fragment,{children:[r.moveHistory.length<=1&&a.jsx(ue,{onClick:Q,$variant:"secondary",children:"Abort"}),a.jsx(ue,{onClick:G,$variant:"secondary",children:"Draw"}),a.jsx(ue,{onClick:z,$variant:"secondary",children:"Resign"}),a.jsx(yr,{color:r.playingColor||"white",size:"small"})]}),v==="observing"&&a.jsxs(a.Fragment,{children:[a.jsx(ue,{onClick:P,$variant:"secondary",children:"Unobserve"}),a.jsx(ue,{onClick:xe,$variant:"secondary",children:"Analysis"})]}),v==="examining"&&a.jsxs(a.Fragment,{children:[a.jsx(ue,{onClick:S,$variant:"secondary",children:"Unexamine"}),a.jsx(ue,{onClick:xe,$variant:"secondary",children:"Analysis"})]}),v==="freestyle"&&a.jsxs(a.Fragment,{children:[a.jsx(ue,{onClick:xe,$variant:"secondary",children:"Analysis"}),a.jsx(ue,{onClick:R,$variant:"secondary",children:"Flip"}),a.jsx(ue,{onClick:w,$variant:"secondary",children:"FEN"})]})]})]}),a.jsxs(hn,{children:[a.jsx(Ye,{player:de,isActive:re,size:"small",compact:!0}),a.jsx(pn,{children:a.jsx(qe,{name:de.name,rating:de.rating,time:0,isActive:re,isWhite:se,orientation:"horizontal",hideClockInCard:!0,compact:!0})})]}),a.jsx(dn,{$orientation:"portrait",children:a.jsx(er,{position:x,flipped:X,showCoordinates:!0,onMove:j,interactive:v==="playing"||v==="freestyle"||v==="examining",lastMove:r.lastMove||void 0,onSizeCalculated:p})}),a.jsxs(hn,{children:[a.jsx(Ye,{player:te,isActive:!re,size:"small",compact:!0}),a.jsx(pn,{children:a.jsx(qe,{name:te.name,rating:te.rating,time:0,isActive:!re,isWhite:!se,orientation:"horizontal",hideClockInCard:!0,compact:!0})})]}),a.jsxs(Vc,{children:[a.jsx(cn,{children:r.premove?`Premove: ${vr(`${r.premove.from}${r.premove.to}${r.premove.promotion||""}`)}`:L!=="Starting position"?`Last move: ${L}`:"Last move: none"}),E&&a.jsx(ln,{children:E})]}),s&&a.jsx(nl,{children:a.jsx(rr,{})})]}),a.jsx(on,{$size:u?u/8:0})]}),k&&a.jsx(Hc,{$squareSize:u?u/8:0,children:a.jsxs(_c,{$squareSize:u?u/8:0,children:[a.jsx(Ve,{orientation:"vertical",isWhitePieces:X,boardSize:u}),a.jsx(Ve,{orientation:"vertical",isWhitePieces:!X,boardSize:u})]})})]})})}),a.jsx(Jc,{$orientation:"portrait",children:a.jsx(xr,{moves:r.moveHistory,currentMoveIndex:r.currentMoveIndex,onMoveClick:ge,disableAutoScroll:!0,onNavigate:I=>{if(r.isExamining)switch(I){case"first":i.sendCommand("back 500");break;case"prev":i.sendCommand("back");break;case"next":i.sendCommand("forward");break;case"last":i.sendCommand("forward 500");break}else switch(I){case"first":r.goToStart();break;case"prev":r.goToPreviousMove();break;case"next":r.goToNextMove();break;case"last":r.goToEnd();break}}})})]});return a.jsxs(Oc,{className:e,$orientation:$?"landscape":"portrait",$hasChat:t,children:[$?a.jsx(a.Fragment,{children:a.jsx(nn,{$orientation:"landscape",children:a.jsxs(Zc,{$hasAnalysis:s,children:[a.jsxs(Bc,{children:[a.jsxs(Gc,{children:[a.jsxs(an,{children:["Game #",F?.gameId||"?"]}),a.jsx(sn,{children:F?.timeControl||"?"})]}),a.jsxs(Wc,{children:[s&&a.jsx(tr,{orientation:"vertical"}),a.jsx(dn,{$orientation:"landscape",children:a.jsx(er,{position:x,flipped:X,showCoordinates:!0,onMove:j,interactive:v==="playing"||v==="freestyle"||v==="examining",lastMove:r.lastMove||void 0,onSizeCalculated:p})})]}),a.jsxs(Uc,{children:[a.jsx(cn,{children:r.premove?`Premove: ${vr(`${r.premove.from}${r.premove.to}${r.premove.promotion||""}`)}`:L!=="Starting position"?`Last move: ${L}`:"Last move: none"}),E&&a.jsx(ln,{children:E})]}),s&&a.jsx(rl,{children:a.jsx(rr,{})})]}),a.jsxs(el,{children:[k&&a.jsx(Ve,{orientation:"horizontal",isWhitePieces:se,boardSize:u}),a.jsxs(un,{children:[a.jsx(Ye,{player:de,isActive:re,size:"small",compact:!0,variant:"landscape"}),a.jsx(qe,{name:de.name,rating:de.rating,time:0,isActive:re,isWhite:se,orientation:"vertical",hideClockInCard:!0,compact:!0})]}),a.jsx(yo,{perspective:v,canAbort:r.moveHistory.length<=1,onAnalysis:xe,onFlipBoard:R,onSetupFEN:w,onUnobserve:P,onUnexamine:S,onResign:z,onDraw:G,onAbort:Q,isAnalysisActive:s,isDrawOffered:y}),a.jsx(tl,{moves:r.moveHistory,currentMoveIndex:r.currentMoveIndex,onMoveClick:ge,showHeader:!1,onNavigate:I=>{if(r.isExamining)switch(I){case"first":i.sendCommand("backward 999");break;case"prev":i.sendCommand("backward");break;case"next":i.sendCommand("forward");break;case"last":i.sendCommand("forward 999");break}else switch(I){case"first":r.goToStart();break;case"prev":r.goToPreviousMove();break;case"next":r.goToNextMove();break;case"last":r.goToEnd();break}}}),a.jsxs(un,{children:[a.jsx(qe,{name:te.name,rating:te.rating,time:0,isActive:!re,isWhite:!se,orientation:"vertical",hideClockInCard:!0,compact:!0}),a.jsx(Ye,{player:te,isActive:!re,size:"small",compact:!0,variant:"landscape"})]}),k&&a.jsx(Ve,{orientation:"horizontal",isWhitePieces:!se,boardSize:u})]})]})})}):J(),a.jsx(vo,{isOpen:c,onClose:()=>l(!1)}),a.jsx(Fc,{isOpen:m,title:"Resign Game",message:"Are you sure you want to resign?",confirmText:"Yes, Resign",cancelText:"Cancel",onConfirm:M,onCancel:()=>g(!1)})]})});Co.displayName="ChessGameLayout";const il=f.div`
  display: flex;
  background-color: ${e=>e.theme.colors.backgroundTertiary};
  border-bottom: 1px solid ${e=>e.theme.colors.border};
  overflow-x: auto;
