...
`,ir=l.button`
  ...
  `}
`,Fo=q(({isOpen:e,onClose:t})=>{const r=Oe(),{settingsRegistry:n}=r,i=Fe(),s=i.isMobileDevice||i.dimensions.width<768,[a,u]=h.useState("board"),[c,d]=h.useState(""),[m,f]=h.useState({}),[g,p]=h.useState({x:0,y:0}),[$,x]=h.useState(!1),[v,y]=h.useState({x:0,y:0}),k=h.useRef(null);if(h.useEffect(()=>{if(e&&k.current&&!s){const w=k.current.getBoundingClientRect();p({x:(window.innerWidth-w.width)/2,y:(window.innerHeight-w.height)/2})}},[e,s]),h.useEffect(()=>{if(!$)return;const w=H=>{p({x:H.clientX-v.x,y:H.clientY-v.y})},O=()=>{x(!1)};return document.addEventListener("mousemove",w),document.addEventListener("mouseup",O),()=>{document.removeEventListener("mousemove",w),document.removeEventListener("mouseup",O)}},[$,v]),!e)return null;const S=n.getAllCategories(),P=c?n.search(c):n.getByCategory(a),C=(w,O)=>{const H=n.get(w);if(H){if(H.validate){const A=H.validate(O);if(typeof A=="string"){f(U=>({...U,[w]:A}));return}else if(A===!1){f(U=>({...U,[w]:"Invalid value"}));return}}f(A=>{const U={...A};return delete U[w],U}),H.value=O,H.onChange?.(O),w in r.preferences&&r.updatePreference(w,O)}},T=w=>{const O=n.get(w);O&&C(w,O.defaultValue)},b=(w,O,H)=>{const A=JSON.parse(localStorage.getItem("customSounds")||"{}"),U=`custom_${w}_${Date.now()}`;A[U]={dataUrl:O,fileName:H,settingId:w,uploadDate:new Date().toISOString()},localStorage.setItem("customSounds",JSON.stringify(A)),C(w,U);const oe=n.get(w);if(oe&&oe.options){const ie={label:`Custom: ${H}`,value:U},de=oe.options.filter(K=>!K.value.startsWith("custom_"));oe.options=[...de,ie]}},R=w=>{if(!(!w||w==="none"))try{let O;if(w.startsWith("custom_")){const U=JSON.parse(localStorage.getItem("customSounds")||"{}")[w];if(U&&U.dataUrl)O=U.dataUrl;else{console.error("Custom sound not found:",w);return}}else O=`/sounds/${w}`;const H=new Audio(O);H.volume=.5,H.play().catch(A=>{console.error("Failed to play sound:",A)})}catch(O){console.error("Error playing sound:",O)}},z=w=>{s||(x(!0),y({x:w.clientX-g.x,y:w.clientY-g.y}))},N=w=>{switch(w.type){case"boolean":return o.jsx(Rc,{type:"checkbox",checked:w.value,onChange:A=>C(w.id,A.target.checked),$isMobile:s});case"select":if(w.id.endsWith("SoundFile")){const A=w.options?.find(ie=>ie.value===w.value),U=A?A.label:"None",oe=w.value&&w.value!=="none";return o.jsxs(Lc,{children:[o.jsx(Dc,{children:U}),o.jsx(Ac,{type:"button",onClick:()=>R(w.value),disabled:!oe,title:oe?"Play sound":"No sound selected",children:"▶️ Play"}),o.jsx(hc,{settingId:w.id,onUpload:b})]})}else return o.jsx(Ec,{value:w.value,onChange:A=>C(w.id,A.target.value),children:w.options?.map(A=>o.jsx("option",{value:A.value,children:A.label},A.value))});case"number":return o.jsx(Mc,{type:"number",value:w.value,min:w.min,max:w.max,step:w.step,onChange:A=>C(w.id,Number(A.target.value))});case"color":return o.jsx(zc,{type:"color",value:w.value,onChange:A=>C(w.id,A.target.value),$isMobile:s});case"text":const H=!!m[w.id];return o.jsxs("div",{style:{width:"100%"},children:[o.jsx(Tc,{value:w.value||"",onChange:A=>C(w.id,A.target.value),className:H?"error":"",placeholder:w.placeholder||"",spellCheck:!1}),H&&o.jsx(Ic,{children:m[w.id]})]});default:return null}};return o.jsx(mc,{children:o.jsxs(pc,{ref:k,$x:g.x,$y:g.y,$isMobile:s,children:[o.jsxs(fc,{onMouseDown:z,children:[o.jsx(gc,{children:"⚙️ Settings"}),o.jsx(xc,{onClick:t,onMouseDown:w=>w.stopPropagation(),children:"✕"})]}),o.jsx(yc,{children:o.jsx(bc,{type:"text",placeholder:"Search settings...",value:c,onChange:w=>d(w.target.value)})}),o.jsxs($c,{$isMobile:s,children:[o.jsx(vc,{$isMobile:s,children:S.map(w=>o.jsxs(wc,{$active:a===w.id&&!c,$isMobile:s,onClick:()=>{u(w.id),d("")},children:[o.jsx(kc,{children:w.icon}),!s&&w.label]},w.id))}),o.jsxs(Sc,{children:[c&&o.jsxs(Fc,{children:["Found ",P.length,' settings matching "',c,'"']}),o.jsx(Cc,{children:P.map(w=>w.type==="text"?o.jsxs(dn,{style:{flexDirection:"column",alignItems:"stretch"},children:[o.jsxs("div",{style:{marginBottom:"8px",display:"flex",justifyContent:"space-between",alignItems:"flex-start"},children:[o.jsxs("div",{children:[o.jsx(un,{children:w.label}),w.description&&o.jsx(hn,{children:w.description})]}),w.value!==w.defaultValue&&o.jsx(mn,{type:"button",onClick:()=>T(w.id),title:"Reset to default",style:{marginLeft:"8px",marginTop:0},children:"↻"})]}),N(w)]},w.id):o.jsxs(dn,{children:[o.jsxs(jc,{children:[o.jsx(un,{children:w.label}),w.description&&o.jsx(hn,{children:w.description})]}),o.jsxs(Pc,{children:[N(w),w.value!==w.defaultValue&&o.jsx(mn,{type:"button",onClick:()=>T(w.id),title:"Reset to default",children:"↻"})]})]},w.id))})]})]}),o.jsxs(Nc,{children:[o.jsx(ir,{onClick:()=>r.resetToDefaults(),children:"Reset to Defaults"}),o.jsxs(Oc,{children:[o.jsx(ir,{onClick:t,children:"Cancel"}),o.jsx(ir,{$variant:"primary",onClick:t,children:"Done"})]})]})]})})});Fo.displayName="SettingsDialog";const Bc=l.div`
  display: flex;
  flex-direction: column;
  height: 100%;
...
`,Nl={K:"wK",Q:"wQ",R:"wR",B:"wB",N:"wN",P:"wP",k:"bK",q:"bQ",r:"bR",b:"bB",n:"bN",p:"bP"},Ol={K:"♔",Q:"♕",R:"♖",B:"♗",N:"♘",P:"♙",k:"♚",q:"♛",r:"♜",b:"♝",n:"♞",p:"♟"},Fl=l.div`
  width: 93%;
  height: 93%;
  display: flex;
  align-items: center;
  ...
  cursor: ${e=>e.$isDragging?"grabbing":"grab"};
  filter: ${e=>e.$isDragging?"drop-shadow(0 4px 8px rgba(0,0,0,0.3))":"none"};
`,Ne=q(({piece:e,size:t,isDragging:r=!1,style:n})=>{const i=Oe(),[s,a]=Z.useState(!1),u=Nl[e];if(!u)return null;const c=i.preferences.pieceSet,d=`/pieces/${c}/${u}.svg`;return Z.useEffect(()=>{a(!1)},[e,c]),s?o.jsx(Fl,{className:"chess-piece-fallback",$isDragging:r,$size:t,style:n,"data-settings":"pieces",children:Ol[e]||e}):o.jsx(Al,{className:"chess-piece",src:d,alt:u,$isDragging:r,draggable:!1,style:n,"data-settings":"pieces",onError:()=>a(!0)})});Ne.displayName="ChessPiece";const Bl=l.div`
...
`,Vl=l.div.attrs(e=>({style:{transform:`translate(
  ...
  justify-content: center;
  will-change: transform;
`,Je=["a","b","c","d","e","f","g","h"],Ze=["8","7","6","5","4","3","2","1"];function ql(e,t){return(e+t)%2===0}function Kl(e,t,r){const n=r?Je[7-e]:Je[e],i=r?Ze[7-t]:Ze[t];return`${n}${i}`}function Xl(e){const t=new Map,[r]=e.split(" ");return r.split("/").forEach((i,s)=>{let a=0;for(const u of i)if(u>="1"&&u<="8")a+=parseInt(u);else{const c=`${Je[a]}${Ze[s]}`;t.set(c,u),a++}}),t}const Sr=q(({position:e,size:t,flipped:r=!1,showCoordinates:n=!0,onMove:i,onDrop:s,highlightedSquares:a=new Set,lastMove:u,interactive:c=!0,onSizeCalculated:d,selectedCapturedPiece:m,onCapturedPieceSelect:f})=>{Fe();const g=Oe(),p=Ht(),$=h.useRef(null),[x,v]=h.useState(t||200),[y,k]=h.useState(null),[S,P]=h.useState(new Set),[C,T]=h.useState(null),[b,R]=h.useState([]),z=h.useRef(),[N,w]=h.useState(null),[O,H]=h.useState(!1),A=h.useMemo(()=>Xl(e),[e]),U=h.useRef(new Map);h.useRef(0);const oe=h.useCallback((j,D)=>{const L=Je.indexOf(j[0]),I=Ze.indexOf(j[1]),E=D/8,M=r?(7-L)*E:L*E,G=r?(7-I)*E:I*E;return{x:M,y:G}},[r]),ie=h.useCallback((j,D,L)=>{const I=j.toLowerCase()==="p",E=L[1];return I&&(E==="8"||E==="1")},[]),de=h.useCallback(j=>{j.preventDefault(),p.isPlaying&&p.clearPremove()},[p]);h.useEffect(()=>{if(t){v(t);return}const j=()=>{if(!$.current)return;const M=$.current.parentElement;if(!M)return;const{width:G,height:te}=M.getBoundingClientRect();$.current.getBoundingClientRect();const ae=16,ee=G-ae,we=te-ae,B=Math.floor(Math.min(ee,we)),le=Math.max(100,Math.floor(B/8)*8);le!==x&&v(le)},D=setTimeout(j,50);j();let L;const I=()=>{clearTimeout(L),L=setTimeout(j,100)};window.addEventListener("resize",I);let E=null;return $.current&&$.current.parentElement&&(E=new ResizeObserver(()=>{I()}),E.observe($.current.parentElement)),()=>{window.removeEventListener("resize",I),clearTimeout(L),clearTimeout(D),E&&E.disconnect()}},[t,x]),h.useEffect(()=>{d&&x>0&&d(x)},[x,d]);const K=x/8,ve=h.useMemo(()=>{if(!g.preferences.animateMoves)return!1;if(p.isPlaying){const j=p.currentGame,D=p.playingColor;if(j&&D){const L=D==="white"?j.white.time:j.black.time,I=g.preferences.disableAnimationsThreshold;if(L<I)return!1}}return!0},[g.preferences.animateMoves,g.preferences.disableAnimationsThreshold,p.isPlaying,p.currentGame,p.playingColor]),pe=h.useRef("");h.useEffect(()=>{if(R([]),!ve||O||p.isProcessingServerUpdate){U.current=new Map(A);return}const j=U.current;if(u){const{from:D,to:L}=u,I=`${e}-${D}-${L}`;if(pe.current===I){U.current=new Map(A);return}const E=j.get(D),M=A.get(L);if(E&&M===E&&!A.has(D)){if(p.isPlaying&&p.currentGame){const G=p.gameRelation===1,te=p.playingColor,ae=te==="white"&&p.currentGame.turn==="b"||te==="black"&&p.currentGame.turn==="w";if(G||ae){U.current=new Map(A),pe.current=I;return}}pe.current=I,setTimeout(()=>{R([{piece:E,from:D,to:L,startTime:Date.now()}])},0)}}U.current=new Map(A)},[A,u,ve,O,p.isProcessingServerUpdate,e,p]),h.useEffect(()=>{if(O){const j=setTimeout(()=>{H(!1)},50);return()=>clearTimeout(j)}},[e,O]),h.useEffect(()=>{if(b.length===0)return;const j=()=>{const D=Date.now(),L=g.preferences.animationDuration;R(I=>{const E=I.filter(M=>D-M.startTime<L);return E.length>0&&(z.current=requestAnimationFrame(j)),E})};return z.current=requestAnimationFrame(j),()=>{z.current&&cancelAnimationFrame(z.current)}},[b.length,g.preferences.animationDuration]),h.useEffect(()=>{if(m)try{const j=p.currentPosition;p.chessBoard.getFen()!==j&&p.chessBoard.loadFen(j);const L=p.chessBoard.getLegalMoves().filter(E=>E.from==="@"&&E.san.toLowerCase().startsWith(m.toLowerCase())),I=new Set(L.map(E=>E.to));P(I),k(null)}catch(j){console.error("Error getting drop moves:",j),P(new Set)}},[m,p]);const Q=h.useCallback((j,D)=>{if(!c)return;const L=A.get(j);if(m){S.has(j)?(s?.(m,j),f?.(null),P(new Set)):(f?.(null),P(new Set));return}if(y)if(S.has(j)){const I=A.get(y);if(I&&ie(I,y,j)){const E=I===I.toUpperCase()?"white":"black";if(p.isPlaying){const M=g.preferences.autoPromotionPiece;p.isMyTurn?(H(!0),i?.(y,j,M)):p.setPremove(y,j,M)}else{const M=D?.currentTarget.getBoundingClientRect();w({from:y,to:j,color:E,position:M?{x:M.left+M.width/2,y:M.top+M.height/2}:{x:window.innerWidth/2,y:window.innerHeight/2}})}}else p.isPlaying&&!p.isMyTurn?p.setPremove(y,j):(H(!0),i?.(y,j));k(null),P(new Set)}else if(j===y)k(null),P(new Set);else if(L)if(k(j),g.preferences.showLegalMoves)try{const I=p.currentPosition;p.chessBoard.getFen()!==I&&p.chessBoard.loadFen(I);const E=p.chessBoard.getLegalMoves(j),M=new Set(E.map(G=>G.to));P(M)}catch(I){console.error("Error getting legal moves:",I),P(new Set)}else P(new Set);else k(null),P(new Set);else if(L){k(j);try{const I=p.currentPosition;p.chessBoard.getFen()!==I&&p.chessBoard.loadFen(I);const E=L===L.toUpperCase(),M=p.chessBoard.getActiveColor();if(E&&M==="w"||!E&&M==="b")if(g.preferences.showLegalMoves){const te=p.chessBoard.getLegalMoves(j),ae=new Set(te.map(ee=>ee.to));P(ae)}else P(new Set);else P(new Set),k(null)}catch(I){console.error("Error getting legal moves:",I),P(new Set)}}},[y,S,A,i,s,c,ie,p,g.preferences.autoPromotionPiece,m,f]),fe=h.useCallback((j,D,L)=>{if(!c)return;const I=j.clientX,E=j.clientY;let M=!1,G=!1;const ae=j.currentTarget.getBoundingClientRect().width,ee=B=>{const le=Math.abs(B.clientX-I),xe=Math.abs(B.clientY-E);(le>3||xe>3)&&L&&!G?(M=!0,G=!0,ge(D,L,B,ae)):G&&T(ce=>ce?{...ce,x:B.clientX,y:B.clientY}:null)},we=B=>{document.removeEventListener("mousemove",ee),document.removeEventListener("mouseup",we),G?ue(B,D,L):M?(T(null),k(null),P(new Set)):Q(D,j)};document.addEventListener("mousemove",ee),document.addEventListener("mouseup",we)},[c,Q]),ge=h.useCallback((j,D,L,I)=>{if(k(j),g.preferences.showLegalMoves)try{const M=p.currentPosition;p.chessBoard.getFen()!==M&&p.chessBoard.loadFen(M);const G=D===D.toUpperCase(),te=p.chessBoard.getActiveColor();if(G&&te==="w"||!G&&te==="b"){const ee=p.chessBoard.getLegalMoves(j),we=new Set(ee.map(B=>B.to));P(we)}else P(new Set)}catch(M){console.error("Error getting legal moves for drag:",M),P(new Set)}else P(new Set);const E={piece:D,from:j,x:L.clientX,y:L.clientY,size:I};T(E)},[g.preferences.showLegalMoves,p]),ue=h.useCallback((j,D,L)=>{try{const M=document.elementsFromPoint(j.clientX,j.clientY).find(G=>G.getAttribute("data-square"))?.getAttribute("data-square");if(M&&M!==D)if(ie(L,D,M)){const G=L===L.toUpperCase()?"white":"black";if(p.isPlaying){const te=g.preferences.autoPromotionPiece;p.isMyTurn?(H(!0),i?.(D,M,te)):p.setPremove(D,M,te)}else w({from:D,to:M,color:G,position:{x:j.clientX,y:j.clientY}})}else p.isPlaying&&!p.isMyTurn?p.setPremove(D,M):(H(!0),i?.(D,M))}catch(I){console.error("Error in handleDragEnd:",I)}T(null),k(null),P(new Set)},[i,ie,p,g.preferences.autoPromotionPiece]),se=h.useMemo(()=>{const j=[];for(let D=0;D<8;D++)for(let L=0;L<8;L++){const I=ql(L,D),E=Kl(L,D,r),M=A.get(E),G=a.has(E),te=u&&(u.from===E||u.to===E),ae=y===E,ee=S.has(E),we=C?.from===E;b.some(ce=>ce.to===E);const B=b.some(ce=>ce.from===E),le=n&&D===7,xe=n&&L===0;j.push(o.jsxs(Gl,{"data-square":E,$isLight:I,$isHighlighted:G,$isLastMoveSquare:!!te,$isSelected:ae,$isPossibleMove:ee,onMouseDown:ce=>fe(ce,E,M),children:[M&&!we&&!B&&o.jsx(Ne,{piece:M,size:K},`${M}-${K}`),le&&o.jsx(xn,{$type:"file",$isLight:I,$size:K,"data-settings":"coordinates",className:"coordinate-label",children:r?Je[7-L]:Je[L]}),xe&&o.jsx(xn,{$type:"rank",$isLight:I,$size:K,"data-settings":"coordinates",className:"coordinate-label",children:r?Ze[7-D]:Ze[D]})]},E))}return j},[r,n,A,a,u,y,S,C,K,Q,fe]);return o.jsxs(o.Fragment,{children:[o.jsxs(_l,{ref:$,$size:x,onContextMenu:de,"data-settings":"board",className:"chess-board",children:[o.jsx(Ul,{children:se}),b.map((j,D)=>{const L=oe(j.from,x),I=oe(j.to,x),E=Date.now()-j.startTime,M=g.preferences.animationDuration,G=Math.min(E/M,1),ae=(ee=>ee<.5?4*ee*ee*ee:1-Math.pow(-2*ee+2,3)/2)(G);return o.jsx(Vl,{$fromX:L.x,$fromY:L.y,$toX:I.x,$toY:I.y,$progress:ae,$size:K,children:o.jsx(Ne,{piece:j.piece,size:K},`${j.piece}-${K}`)},`${j.from}-${j.to}-${j.startTime}`)})]}),C&&o.jsx(o.Fragment,{children:o.jsx(Yl,{$x:C.x,$y:C.y,$size:C.size,children:o.jsx(Ne,{piece:C.piece,size:C.size,isDragging:!0},`${C.piece}-${C.size}-dragging`)})}),N&&o.jsx(Ho,{isOpen:!0,color:N.color,position:N.position,onSelect:j=>{H(!0),i?.(N.from,N.to,j),w(null)},onCancel:()=>w(null)})]})});Sr.displayName="ChessBoardWithPieces";const Ql=l.div`
...
`,_o=({name:e,className:t,style:r,onClick:n})=>{const[i,s]=h.useState(null),a=u=>{u.preventDefault(),u.stopPropagation(),n&&n(),s({x:u.clientX,y:u.clientY})};return o.jsxs(o.Fragment,{children:[o.jsx(od,{className:t,style:r,onClick:a,children:e}),i&&o.jsx(Fr,{playerName:e,position:i,onClose:()=>s(null)})]})};_o.displayName="PlayerName";const id=l.div`
  display: flex;
  flex-direction: column;
...
`,Cr=q(({orientation:e="vertical",boardSize:t})=>{const r=Wt();return o.jsx(vd,{$orientation:e,$boardSize:t,children:o.jsx(Go,{evaluation:r.evaluation,percent:r.evaluationPercent,orientation:e})})}),jr=q(({className:e})=>{const t=Wt();return o.jsxs(wd,{className:e,children:[o.jsxs("div",{className:"depth",children:["Depth ",t.depth||0]}),o.jsx("div",{className:"line",children:t.principalVariation||(t.currentLine?t.currentLine.pv.join(" "):null)||"Calculating..."})]})});Cr.displayName="AnalysisDisplay";jr.displayName="AnalysisInfoDisplay";const kd=l.div`
  display: ${e=>e.$isOpen?"flex":"none"};
  position: fixed;
  top: 0;
  left: 0;
...
`,Pn=l.button`
  ...
  `}
`,Hd=({isOpen:e,title:t,message:r,confirmText:n="Confirm",cancelText:i="Cancel",onConfirm:s,onCancel:a})=>o.jsx(Ad,{$isOpen:e,onClick:a,children:o.jsxs(Nd,{onClick:u=>u.stopPropagation(),children:[o.jsx(Od,{children:t}),o.jsx(Fd,{children:r}),o.jsxs(Bd,{children:[o.jsx(Pn,{$variant:"secondary",onClick:a,children:i}),o.jsx(Pn,{$variant:"primary",onClick:s,children:n})]})]})}),Wd=l.div`
    width: 100%;
    height: 100%;
...
`,Mn=l.div`
    ...
    font-weight: ${e=>e.theme.typography.fontWeight.normal};
`,zn=l.div`
    font-size: ${e=>e.$gameInfoFontSize?`${e.$gameInfoFontSize}px`:e.theme.typography.fontSize.xs};
    color: ${e=>e.$gameInfoColor||e.theme.colors.textTertiary};
    font-weight: ${e=>e.theme.typography.fontWeight.normal};
`,Ln=l.div`
    font-size: ${e=>e.$gameInfoFontSize?`${e.$gameInfoFontSize}px`:e.theme.typography.fontSize.xs};
    color: ${e=>e.$gameInfoColor||e.theme.colors.textTertiary};
...
`)?e.substring(1):e,m=p=>{if(!t)return p;const $={30:"#000000",31:"#CC0000",32:"#4E9A06",33:"#C4A000",34:"#3465A4",35:"#75507B",36:"#06989A",37:"#D3D7CF",90:"#555753",91:"#EF2929",92:"#8AE234",93:"#FCE94F",94:"#729FCF",95:"#AD7FA8",96:"#34E2E2",97:"#EEEEEC"};return p.replace(/\x1b\[(\d+)m/g,(x,v)=>{const y=$[v];return y?`<span style="color: ${y}">`:v==="0"?"</span>":""})},f=p=>{const $=[];if(p.match(/^\w+(?:\([^)]*\))*\s*tells\s+you:|^\s*\w+(?:\([^)]*\))*\((\d+)\):/m)){const v=/(https?:\/\/[^\s]+)\s*$/gm;let y;for(;(y=v.exec(p))!==null;){const k=y[1],S=y.index,P=y.index+y[0].length,C=p.substring(P).match(/^\n\s+([^\s]+)/);if(C&&C[1].match(/[.\/\-?=&]/)){const T=k+C[1],b=P+C[0].length;$.push({start:S,end:b,url:T})}}}return $},g=p=>{const $=m(p),x=f(e),v=[{regex:/(https?:\/\/[^\s]+)/g,handler:(b,R)=>{const z=b[0],N=R||z;return o.jsx(Ie,{href:N,target:"_blank",rel:"noopener noreferrer",onClick:w=>{w.preventDefault(),window.open(N,"_blank")},children:z})}},{regex:/^(\w+) tells you:/gm,handler:b=>{const R=b[1];return o.jsxs("span",{children:[o.jsx(Ie,{onClick:z=>{z.preventDefault(),z.stopPropagation(),c({playerName:R,x:z.clientX,y:z.clientY})},children:R}),b[0].substring(R.length)]},`player-${R}`)}},{regex:/\bGame (\d+)\b/g,handler:b=>o.jsx(Ie,{onClick:R=>{R.preventDefault(),n.sendCommand(`observe ${b[1]}`)},children:b[0]})}],y=s.loggedInUsers.size>0?{regex:/\b[A-Za-z][A-Za-z0-9_-]{2,16}\b/g,handler:b=>{const R=b[0];return s.isUserLoggedIn(R)?o.jsx(Ie,{onClick:z=>{z.preventDefault(),z.stopPropagation(),c({playerName:R,x:z.clientX,y:z.clientY})},children:R}):R}}:null;if(t&&$!==p)return o.jsx("span",{dangerouslySetInnerHTML:{__html:$}});let k=0;const S=[],P=[],C=[];if(r.forEach(b=>{const R=d!==e?b.start-1:b.start;if(R>=0&&R<p.length){const z=b.type==="command"&&b.text.includes(":")&&(b.text.match(/^\s*\d+\s+/)||b.text.match(/^%\d+:/)||b.text.match(/^\d+:/)),N=(()=>{const w=(()=>{switch(b.type){case"command":return o.jsx(Ie,{onClick:O=>{O.preventDefault(),n.sendCommand(b.action||b.value)},children:b.text});case"player":return o.jsx(Ie,{onClick:O=>{O.preventDefault(),O.stopPropagation(),c({playerName:b.text,x:O.clientX,y:O.clientY})},children:b.text});case"gameNumber":return o.jsx(Ie,{onClick:O=>{O.preventDefault(),n.sendCommand(`observe ${b.value}`)},children:b.text});default:return b.text}})();return z?o.jsx(wu,{children:w}):w})();C.push({start:R,end:R+b.text.length,render:N,priority:20})}}),x.forEach(b=>{const R=p.substring(b.start).match(/^(https?:\/\/[^\s]+)/);if(R){const z=R[1];C.push({start:b.start,end:b.start+z.length,render:o.jsx(Ie,{href:b.url,target:"_blank",rel:"noopener noreferrer",onClick:N=>{N.preventDefault(),window.open(b.url,"_blank")},children:z}),priority:10}),P.push([b.start,b.end])}}),v.forEach(b=>{const R=new RegExp(b.regex);let z;for(;(z=R.exec(p))!==null;){const N=z.index,w=N+z[0].length;P.some(([H,A])=>N>=H&&N<A||w>H&&w<=A)||C.push({start:N,end:w,render:b.handler(z),priority:1})}}),y){const b=new RegExp(y.regex);let R;for(;(R=b.exec(p))!==null;){const z=R.index,N=z+R[0].length;if(!P.some(([O,H])=>z>=O&&z<H||N>O&&N<=H)){const O=y.handler(R);O!==R[0]&&C.push({start:z,end:N,render:O,priority:0})}}}return C.sort((b,R)=>b.start!==R.start?b.start-R.start:R.priority-b.priority),C.filter((b,R)=>{if(R===0)return!0;const z=C[R-1];return b.start>=z.end}).forEach((b,R)=>{b.start>k&&S.push(p.substring(k,b.start)),S.push(o.jsx(Z.Fragment,{children:b.render},R)),k=b.end}),k<p.length&&S.push(p.substring(k)),S.length>0?S:p};return o.jsxs(o.Fragment,{children:[o.jsx(vu,{$fontSize:a.fontSize,children:g(d)}),u&&o.jsx(Fr,{playerName:u.playerName,position:{x:u.x,y:u.y},onClose:()=>c(null)})]})}),An=l.div`
  margin: 0;
`,ku=l.a`
  color: ${e=>e.theme.colors.primary};
  cursor: pointer;
