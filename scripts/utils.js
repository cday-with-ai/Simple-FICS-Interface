 ...
 *
 * @param {string} style12 - The Style12 message from FICS
 * @returns {string} - The FEN representation of the position
 */
export function style12ToFen(style12) {
    ...
    // Fullmove number
    const fullmoveNumber = parts[25] === '300' ? '1' : parts[25] === '122' ? '2' : parts[25];
 ...
 */
export function toAlgebraicSquare(rank, file) {
 ...
 */
export function toRankFile(algebraicSquare) {
    return {
 ...
 * @param {string} moveNotation - The move in the format, e.g. "P/e2-e4","K/e1-e2","o-o","o-o-o","P/e7-e8=Q"
 * @returns {string[]} - Array containing the start and end squares in algebraic notation, e.g. ['e2', 'e4']
 */
export function parseVerboseMove(moveNotation, isWhitesMove) {
    // Validate input
 ...
 * @param {string} square - The algebraic notation of the square (e.g., 'e4')
 * @returns {string} - The piece at the square ('P', 'N', 'B', 'R', 'Q', 'K', 'p', 'n', 'b', 'r', 'q', 'k') or empty string if the square is empty
 */
export function getPieceAtSquare(fen, square) {
    // Validate inputs
 ...
 * @returns {string} The short algebraic move.
 */
export function startEndToAlgebraic(algebraicStart, algebraicEnd, fen) {
    // Validate inputs
 ...
 * @param {string} fen - The FEN string representing the position
 * @param {string} pieceType - The piece type (P, N, B, R, Q, K)
 * @param {string} targetSquare - The target square in algebraic notation
 * @param {string} excludeSquare - The square to exclude from the search
 * @returns {string[]} - Array of squares containing pieces that can move to the target
 */
function findAmbiguousPieces(fen, pieceType, targetSquare, excludeSquare) {
    const result = [];
 ...
 * @returns {string[]} - Array containing the start and end squares in algebraic notation, e.g. ['e2', 'e4']
 */
export function ficsMoveToStartEndArray(ficsMoveSyntax) {
