...
`,No=Z(({className:e,hasChat:t=!1})=>{const n=yn(),r=Ke(),o=Tt(),i=Rr(),a=Go();Bt();const[d,c]=h.useState(!1),[l,p]=h.useState(!1),[u,f]=h.useState(0),[g,v]=h.useState(!1),[$,k]=h.useState(!1),[y,j]=h.useState(null),R=r.preferences.chessOrientation==="landscape",P=n.currentPosition||"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",M=h.useMemo(()=>!n.currentGame||n.currentGame.gameId<0?"freestyle":n.isPlaying?"playing":n.isObserving?"observing":n.isExamining?"examining":"observing",[n.currentGame,n.gameRelation]),D=h.useMemo(()=>n.currentGame?.variant==="crazyhouse"?!0:r.preferences.showCapturedPieces,[n.currentGame?.variant,r.preferences.showCapturedPieces]),A=h.useCallback((F,X,Y)=>{try{n.makeMove(F,X,Y)||(console.error("Invalid move:",F,X),a.playIllegal())}catch(oe){console.error("Error making move:",oe),a.playIllegal()}},[n,a]),_=h.useCallback((F,X)=>{try{const Y=F.toLowerCase();n.makeSANMove(`${F.toUpperCase()}@${X}`)||(console.error("Invalid drop:",F,X),a.playIllegal())}catch(Y){console.error("Error making drop:",Y),a.playIllegal()}},[n,a]),H=h.useCallback(F=>{j(y===F?null:F)},[y]);h.useMemo(()=>{if(n.currentGameInfo){const{white:F,black:X,timeControl:Y,variant:oe}=n.currentGameInfo;return`Game ${n.currentGame?.gameId||"?"} • ${oe} ${Y}`}return"No active game"},[n.currentGameInfo,n.currentGame]);const x=(()=>{const F=n.moveHistory.length;if(F>0){const X=n.moveHistory[F-1],Y=Math.ceil(F/2),oe=F%2===1,ie=tn(X.san);return`${Y}.${oe?"":".."} ${ie}`}return"Starting position"})(),b=n.currentOpening,w=n.currentGame,C=w||n.lastGameState,L=C?.white||{name:"White",rating:1500,time:900},B=C?.black||{name:"Black",rating:1500,time:900},U=!w||w.turn==="w",K=n.shouldShowFlippedBoard,le=K?L:B,q=K?B:L,se=K,ee=K?U:!U,ae=h.useCallback(F=>{n.goToMove(F)},[n]);h.useEffect(()=>{o.initialize()},[o]),h.useEffect(()=>{$&&n.isPlaying&&n.currentGame&&i.sendCommand("draw")},[n.moveHistory.length,$,n.isPlaying,i]),h.useEffect(()=>{(!n.currentGame||!n.isPlaying)&&k(!1)},[n.currentGame,n.isPlaying]),h.useEffect(()=>{d&&o.isEngineReady?o.startAnalysis(P):o.stopAnalysis()},[d,P,o]);const be=h.useCallback(()=>{c(F=>!F)},[]),Se=h.useCallback(()=>{p(!0)},[]),$e=h.useCallback(()=>{r.updatePreference("boardFlipped",!r.preferences.boardFlipped)},[r]),S=h.useCallback(()=>{n.currentGame&&i.sendCommand(`unobs ${n.currentGame.gameId}`)},[i,n.currentGame]),N=h.useCallback(()=>{i.sendCommand("unexamine")},[i]),I=h.useCallback(()=>{v(!0)},[]),T=h.useCallback(()=>{i.sendCommand("resign"),v(!1)},[i]),z=h.useCallback(()=>{i.sendCommand("draw"),k(!$)},[i,$]),E=h.useCallback(()=>{i.sendCommand("abort")},[i]),W=()=>s.jsxs(s.Fragment,{children:[s.jsx(hr,{$orientation:"portrait",children:s.jsx(cl,{children:s.jsxs(ll,{children:[d&&s.jsx(yl,{$squareSize:u?u/8:0,children:s.jsx(fn,{orientation:"vertical",boardSize:u})}),s.jsxs(dl,{children:[s.jsx(pr,{$size:u?u/8:0}),s.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center"},id:"board-container",children:[s.jsxs(il,{children:[s.jsxs(mr,{children:["Game #",C?.gameId||"?"]}),s.jsx(fr,{children:C?.timeControl||"?"}),s.jsxs(sl,{children:[M==="playing"&&s.jsxs(s.Fragment,{children:[n.moveHistory.length<=1&&s.jsx(me,{onClick:E,$variant:"secondary",children:"Abort"}),s.jsx(me,{onClick:z,$variant:"secondary",children:"Draw"}),s.jsx(me,{onClick:I,$variant:"secondary",children:"Resign"}),s.jsx(Tn,{color:n.playingColor||"white",size:"small"})]}),M==="observing"&&s.jsxs(s.Fragment,{children:[s.jsx(me,{onClick:S,$variant:"secondary",children:"Unobserve"}),s.jsx(me,{onClick:be,$variant:"secondary",children:"Analysis"})]}),M==="examining"&&s.jsxs(s.Fragment,{children:[s.jsx(me,{onClick:N,$variant:"secondary",children:"Unexamine"}),s.jsx(me,{onClick:be,$variant:"secondary",children:"Analysis"})]}),M==="freestyle"&&s.jsxs(s.Fragment,{children:[s.jsx(me,{onClick:be,$variant:"secondary",children:"Analysis"}),s.jsx(me,{onClick:$e,$variant:"secondary",children:"Flip"}),s.jsx(me,{onClick:Se,$variant:"secondary",children:"FEN"})]})]})]}),s.jsxs($r,{children:[s.jsx(nt,{player:le,isActive:ee,size:"small",compact:!0}),s.jsx(vr,{children:s.jsx(tt,{name:le.name,rating:le.rating,time:0,isActive:ee,isWhite:se,orientation:"horizontal",hideClockInCard:!0,compact:!0})})]}),s.jsx(xr,{$orientation:"portrait",children:s.jsx(mn,{position:P,flipped:K,showCoordinates:!0,onMove:A,onDrop:_,interactive:M==="playing"||M==="freestyle"||M==="examining",lastMove:n.lastMove||void 0,onSizeCalculated:f,selectedCapturedPiece:y,onCapturedPieceSelect:j})}),s.jsxs($r,{children:[s.jsx(nt,{player:q,isActive:!ee,size:"small",compact:!0}),s.jsx(vr,{children:s.jsx(tt,{name:q.name,rating:q.rating,time:0,isActive:!ee,isWhite:!se,orientation:"horizontal",hideClockInCard:!0,compact:!0})})]}),s.jsxs(al,{children:[s.jsx(gr,{children:n.premove?`Premove: ${Ln(`${n.premove.from}${n.premove.to}${n.premove.promotion||""}`,P)}`:x!=="Starting position"?`Last move: ${x}`:"Last move: none"}),b&&s.jsx(yr,{children:b})]}),d&&s.jsx(gl,{children:s.jsx(gn,{})})]}),s.jsx(pr,{$size:u?u/8:0})]}),D&&s.jsx(tl,{$squareSize:u?u/8:0,children:s.jsxs(nl,{$squareSize:u?u/8:0,children:[s.jsx(rt,{orientation:"vertical",isWhitePieces:K,boardSize:u,onPieceClick:H}),s.jsx(rt,{orientation:"vertical",isWhitePieces:!K,boardSize:u,onPieceClick:H})]})})]})})}),s.jsx(ul,{$orientation:"portrait",children:s.jsx(Mn,{moves:n.moveHistory,currentMoveIndex:n.currentMoveIndex,onMoveClick:ae,disableAutoScroll:!0,onNavigate:F=>{if(n.isExamining)switch(F){case"first":i.sendCommand("back 500");break;case"prev":i.sendCommand("back");break;case"next":i.sendCommand("forward");break;case"last":i.sendCommand("forward 500");break}else switch(F){case"first":n.goToStart();break;case"prev":n.goToPreviousMove();break;case"next":n.goToNextMove();break;case"last":n.goToEnd();break}}})})]});return s.jsxs(Qc,{className:e,$orientation:R?"landscape":"portrait",$hasChat:t,children:[R?s.jsx(s.Fragment,{children:s.jsx(hr,{$orientation:"landscape",children:s.jsxs(hl,{$hasAnalysis:d,children:[s.jsxs(Zc,{children:[s.jsxs(rl,{children:[s.jsxs(mr,{children:["Game #",C?.gameId||"?"]}),s.jsx(fr,{children:C?.timeControl||"?"})]}),s.jsxs(el,{children:[d&&s.jsx(fn,{orientation:"vertical"}),s.jsx(xr,{$orientation:"landscape",children:s.jsx(mn,{position:P,flipped:K,showCoordinates:!0,onMove:A,onDrop:_,interactive:M==="playing"||M==="freestyle"||M==="examining",lastMove:n.lastMove||void 0,onSizeCalculated:f,selectedCapturedPiece:y,onCapturedPieceSelect:j})})]}),s.jsxs(ol,{children:[s.jsx(gr,{children:n.premove?`Premove: ${Ln(`${n.premove.from}${n.premove.to}${n.premove.promotion||""}`,P)}`:x!=="Starting position"?`Last move: ${x}`:"Last move: none"}),b&&s.jsx(yr,{children:b})]}),d&&s.jsx(fl,{children:s.jsx(gn,{})})]}),s.jsxs(pl,{children:[D&&s.jsx(rt,{orientation:"horizontal",isWhitePieces:se,boardSize:u,onPieceClick:H}),s.jsxs(br,{children:[s.jsx(nt,{player:le,isActive:ee,size:"small",compact:!0,variant:"landscape"}),s.jsx(tt,{name:le.name,rating:le.rating,time:0,isActive:ee,isWhite:se,orientation:"vertical",hideClockInCard:!0,compact:!0})]}),s.jsx(Mo,{perspective:M,canAbort:n.moveHistory.length<=1,onAnalysis:be,onFlipBoard:$e,onSetupFEN:Se,onUnobserve:S,onUnexamine:N,onResign:I,onDraw:z,onAbort:E,isAnalysisActive:d,isDrawOffered:$}),s.jsx(ml,{moves:n.moveHistory,currentMoveIndex:n.currentMoveIndex,onMoveClick:ae,showHeader:!1,onNavigate:F=>{if(n.isExamining)switch(F){case"first":i.sendCommand("backward 999");break;case"prev":i.sendCommand("backward");break;case"next":i.sendCommand("forward");break;case"last":i.sendCommand("forward 999");break}else switch(F){case"first":n.goToStart();break;case"prev":n.goToPreviousMove();break;case"next":n.goToNextMove();break;case"last":n.goToEnd();break}}}),s.jsxs(br,{children:[s.jsx(tt,{name:q.name,rating:q.rating,time:0,isActive:!ee,isWhite:!se,orientation:"vertical",hideClockInCard:!0,compact:!0}),s.jsx(nt,{player:q,isActive:!ee,size:"small",compact:!0,variant:"landscape"})]}),D&&s.jsx(rt,{orientation:"horizontal",isWhitePieces:!se,boardSize:u,onPieceClick:H})]})]})})}):W(),s.jsx(Lo,{isOpen:l,onClose:()=>p(!1)}),s.jsx(Xc,{isOpen:g,title:"Resign Game",message:"Are you sure you want to resign?",confirmText:"Yes, Resign",cancelText:"Cancel",onConfirm:T,onCancel:()=>v(!1)})]})});No.displayName="ChessGameLayout";const xl=m.div`
  display: flex;
  background-color: ${e=>e.theme.colors.backgroundTertiary};
  border-bottom: 1px solid ${e=>e.theme.colors.border};
  overflow-x: auto;
