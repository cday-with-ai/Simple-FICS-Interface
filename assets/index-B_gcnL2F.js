...
`,Lo=({isOpen:e,color:t,onSelect:r,onCancel:n,position:o})=>{if(!o)return null;const s=["Q","R","B","N"],a=d=>t==="white"?d:d.toLowerCase();return i.jsx(_c,{$isOpen:e,onClick:n,children:i.jsx(Gc,{$x:o.x,$y:o.y,onClick:d=>d.stopPropagation(),children:s.map(d=>i.jsx(Uc,{onClick:()=>r(d.toLowerCase()),children:i.jsx(Ae,{piece:a(d),size:50})},d))})})};Lo.displayName="PromotionDialog";const Yc=h.div`
  width: ${e=>e.$size}px;
  height: ${e=>e.$size}px;
  position: relative;
...
`,Xc=h.div.attrs(e=>({style:{transform:`translate(
  ...
  justify-content: center;
  will-change: transform;
`,qe=["a","b","c","d","e","f","g","h"],Ke=["8","7","6","5","4","3","2","1"];function Qc(e,t){return(e+t)%2===0}function Jc(e,t,r){const n=r?qe[7-e]:qe[e],o=r?Ke[7-t]:Ke[t];return`${n}${o}`}function Zc(e){const t=new Map,[r]=e.split(" ");return r.split("/").forEach((o,s)=>{let a=0;for(const d of o)if(d>="1"&&d<="8")a+=parseInt(d);else{const c=`${qe[a]}${Ke[s]}`;t.set(c,d),a++}}),t}const $r=X(({position:e,size:t,flipped:r=!1,showCoordinates:n=!0,onMove:o,onDrop:s,highlightedSquares:a=new Set,lastMove:d,interactive:c=!0,onSizeCalculated:l,selectedCapturedPiece:p,onCapturedPieceSelect:m})=>{Ne();const g=De(),f=Ot(),$=u.useRef(null),[y,v]=u.useState(t||200),[x,j]=u.useState(null),[k,P]=u.useState(new Set),[b,S]=u.useState(null),[R,A]=u.useState([]),O=u.useRef(),[H,w]=u.useState(null),[F,B]=u.useState(!1),I=u.useMemo(()=>Zc(e),[e]),G=u.useRef(new Map);u.useRef(0);const ee=u.useCallback((C,L)=>{const z=qe.indexOf(C[0]),T=Ke.indexOf(C[1]),E=L/8,M=r?(7-z)*E:z*E,U=r?(7-T)*E:T*E;return{x:M,y:U}},[r]),ce=u.useCallback((C,L,z)=>{const T=C.toLowerCase()==="p",E=z[1];return T&&(E==="8"||E==="1")},[]),Se=u.useCallback(C=>{C.preventDefault(),f.isPlaying&&f.clearPremove()},[f]);u.useEffect(()=>{if(t){v(t);return}const C=()=>{if(!$.current)return;const M=$.current.parentElement;if(!M)return;const{width:U,height:re}=M.getBoundingClientRect();$.current.getBoundingClientRect();const le=16,D=U-le,ie=re-le,Q=Math.floor(Math.min(D,ie)),ue=Math.max(100,Math.floor(Q/8)*8);ue!==y&&v(ue)},L=setTimeout(C,50);C();let z;const T=()=>{clearTimeout(z),z=setTimeout(C,100)};window.addEventListener("resize",T);let E=null;return $.current&&$.current.parentElement&&(E=new ResizeObserver(()=>{T()}),E.observe($.current.parentElement)),()=>{window.removeEventListener("resize",T),clearTimeout(z),clearTimeout(L),E&&E.disconnect()}},[t,y]),u.useEffect(()=>{l&&y>0&&l(y)},[y,l]);const q=y/8,se=u.useMemo(()=>{if(!g.preferences.animateMoves)return!1;if(f.isPlaying){const C=f.currentGame,L=f.playingColor;if(C&&L){const z=L==="white"?C.white.time:C.black.time,T=g.preferences.disableAnimationsThreshold;if(z<T)return!1}}return!0},[g.preferences.animateMoves,g.preferences.disableAnimationsThreshold,f.isPlaying,f.currentGame,f.playingColor]),ae=u.useRef("");u.useEffect(()=>{if(A([]),!se||F||f.isProcessingServerUpdate){G.current=new Map(I);return}const C=G.current;if(d){const{from:L,to:z}=d,T=`${e}-${L}-${z}`;if(ae.current===T){G.current=new Map(I);return}const E=C.get(L),M=I.get(z);if(E&&M===E&&!I.has(L)){if(f.isPlaying&&f.currentGame){const U=f.gameRelation===1,re=f.playingColor,le=re==="white"&&f.currentGame.turn==="b"||re==="black"&&f.currentGame.turn==="w";if(U||le){G.current=new Map(I),ae.current=T;return}}ae.current=T,setTimeout(()=>{A([{piece:E,from:L,to:z,startTime:Date.now()}])},0)}}G.current=new Map(I)},[I,d,se,F,f.isProcessingServerUpdate,e,f]),u.useEffect(()=>{if(F){const C=setTimeout(()=>{B(!1)},50);return()=>clearTimeout(C)}},[e,F]),u.useEffect(()=>{if(R.length===0)return;const C=()=>{const L=Date.now(),z=g.preferences.animationDuration;A(T=>{const E=T.filter(M=>L-M.startTime<z);return E.length>0&&(O.current=requestAnimationFrame(C)),E})};return O.current=requestAnimationFrame(C),()=>{O.current&&cancelAnimationFrame(O.current)}},[R.length,g.preferences.animationDuration]),u.useEffect(()=>{if(p)try{const C=f.currentPosition;f.chessBoard.getFen()!==C&&f.chessBoard.loadFen(C);const z=f.chessBoard.getLegalMoves().filter(E=>E.from==="@"&&E.san.toLowerCase().startsWith(p.toLowerCase())),T=new Set(z.map(E=>E.to));P(T),j(null)}catch(C){console.error("Error getting drop moves:",C),P(new Set)}},[p,f]);const te=u.useCallback((C,L)=>{if(!c)return;const z=I.get(C);if(p){k.has(C)?(s?.(p,C),m?.(null),P(new Set)):(m?.(null),P(new Set));return}if(x)if(k.has(C)){const T=I.get(x);if(T&&ce(T,x,C)){const E=T===T.toUpperCase()?"white":"black";if(f.isPlaying){const M=g.preferences.autoPromotionPiece;f.isMyTurn?(B(!0),o?.(x,C,M)):f.setPremove(x,C,M)}else{const M=L?.currentTarget.getBoundingClientRect();w({from:x,to:C,color:E,position:M?{x:M.left+M.width/2,y:M.top+M.height/2}:{x:window.innerWidth/2,y:window.innerHeight/2}})}}else f.isPlaying&&!f.isMyTurn?f.setPremove(x,C):(B(!0),o?.(x,C));j(null),P(new Set)}else if(C===x)j(null),P(new Set);else if(z)if(j(C),g.preferences.showLegalMoves)try{const T=f.currentPosition;f.chessBoard.getFen()!==T&&f.chessBoard.loadFen(T);const E=f.chessBoard.getLegalMoves(C),M=new Set(E.map(U=>U.to));P(M)}catch(T){console.error("Error getting legal moves:",T),P(new Set)}else P(new Set);else j(null),P(new Set);else if(z){j(C);try{const T=f.currentPosition;f.chessBoard.getFen()!==T&&f.chessBoard.loadFen(T);const E=z===z.toUpperCase(),M=f.chessBoard.getActiveColor();if(E&&M==="w"||!E&&M==="b")if(g.preferences.showLegalMoves){const re=f.chessBoard.getLegalMoves(C),le=new Set(re.map(D=>D.to));P(le)}else P(new Set);else P(new Set),j(null)}catch(T){console.error("Error getting legal moves:",T),P(new Set)}}},[x,k,I,o,s,c,ce,f,g.preferences.autoPromotionPiece,p,m]),me=u.useCallback((C,L,z)=>{if(!c)return;const T=C.clientX,E=C.clientY;let M=!1,U=!1;const le=C.currentTarget.getBoundingClientRect().width,D=Q=>{const ue=Math.abs(Q.clientX-T),nt=Math.abs(Q.clientY-E);(ue>3||nt>3)&&z&&!U?(M=!0,U=!0,de(L,z,Q,le)):U&&S(ze=>ze?{...ze,x:Q.clientX,y:Q.clientY}:null)},ie=Q=>{document.removeEventListener("mousemove",D),document.removeEventListener("mouseup",ie),U?Ce(Q,L,z):M?(S(null),j(null),P(new Set)):te(L,C)};document.addEventListener("mousemove",D),document.addEventListener("mouseup",ie)},[c,te]),de=u.useCallback((C,L,z,T)=>{if(j(C),g.preferences.showLegalMoves)try{const M=f.currentPosition;f.chessBoard.getFen()!==M&&f.chessBoard.loadFen(M);const U=L===L.toUpperCase(),re=f.chessBoard.getActiveColor();if(U&&re==="w"||!U&&re==="b"){const D=f.chessBoard.getLegalMoves(C),ie=new Set(D.map(Q=>Q.to));P(ie)}else P(new Set)}catch(M){console.error("Error getting legal moves for drag:",M),P(new Set)}else P(new Set);const E={piece:L,from:C,x:z.clientX,y:z.clientY,size:T};S(E)},[g.preferences.showLegalMoves,f]),Ce=u.useCallback((C,L,z)=>{try{const M=document.elementsFromPoint(C.clientX,C.clientY).find(U=>U.getAttribute("data-square"))?.getAttribute("data-square");if(M&&M!==L)if(ce(z,L,M)){const U=z===z.toUpperCase()?"white":"black";if(f.isPlaying){const re=g.preferences.autoPromotionPiece;f.isMyTurn?(B(!0),o?.(L,M,re)):f.setPremove(L,M,re)}else w({from:L,to:M,color:U,position:{x:C.clientX,y:C.clientY}})}else f.isPlaying&&!f.isMyTurn?f.setPremove(L,M):(B(!0),o?.(L,M))}catch(T){console.error("Error in handleDragEnd:",T)}S(null),j(null),P(new Set)},[o,ce,f,g.preferences.autoPromotionPiece]),fe=u.useMemo(()=>{const C=[];for(let L=0;L<8;L++)for(let z=0;z<8;z++){const T=Qc(z,L),E=Jc(z,L,r),M=I.get(E),U=a.has(E),re=d&&(d.from===E||d.to===E),le=x===E,D=k.has(E),ie=b?.from===E;R.some(ze=>ze.to===E);const Q=R.some(ze=>ze.from===E),ue=n&&L===7,nt=n&&z===0;C.push(i.jsxs(qc,{"data-square":E,$isLight:T,$isHighlighted:U,$isLastMoveSquare:!!re,$isSelected:le,$isPossibleMove:D,onMouseDown:ze=>me(ze,E,M),children:[M&&!ie&&!Q&&i.jsx(Ae,{piece:M,size:q},`${M}-${q}`),ue&&i.jsx(un,{$type:"file",$isLight:T,$size:q,"data-settings":"coordinates",className:"coordinate-label",children:r?qe[7-z]:qe[z]}),nt&&i.jsx(un,{$type:"rank",$isLight:T,$size:q,"data-settings":"coordinates",className:"coordinate-label",children:r?Ke[7-L]:Ke[L]})]},E))}return C},[r,n,I,a,d,x,k,b,q,te,me]);return i.jsxs(i.Fragment,{children:[i.jsxs(Yc,{ref:$,$size:y,onContextMenu:Se,"data-settings":"board",className:"chess-board",children:[i.jsx(Vc,{children:fe}),R.map((C,L)=>{const z=ee(C.from,y),T=ee(C.to,y),E=Date.now()-C.startTime,M=g.preferences.animationDuration,U=Math.min(E/M,1),le=(D=>D<.5?4*D*D*D:1-Math.pow(-2*D+2,3)/2)(U);return i.jsx(Xc,{$fromX:z.x,$fromY:z.y,$toX:T.x,$toY:T.y,$progress:le,$size:q,children:i.jsx(Ae,{piece:C.piece,size:q},`${C.piece}-${q}`)},`${C.from}-${C.to}-${C.startTime}`)})]}),b&&i.jsx(i.Fragment,{children:i.jsx(Kc,{$x:b.x,$y:b.y,$size:b.size,children:i.jsx(Ae,{piece:b.piece,size:b.size,isDragging:!0},`${b.piece}-${b.size}-dragging`)})}),H&&i.jsx(Lo,{isOpen:!0,color:H.color,position:H.position,onSelect:C=>{B(!0),o?.(H.from,H.to,C),w(null)},onCancel:()=>w(null)})]})});$r.displayName="ChessBoardWithPieces";const el=h.div`
...
`;const st=X(({name:e,rating:t,time:r,isActive:n,isWhite:o,orientation:s="horizontal",hideClockInCard:a=!1,onlyInfo:d=!1,compact:c=!1})=>{const l=i.jsxs(i.Fragment,{children:[i.jsx(ll,{children:i.jsxs(dl,{children:[i.jsx(ul,{children:i.jsx(Ao,{name:e})}),i.jsx(hl,{children:t===-1?"++++":t===-2?"----":t})]})}),!a&&!d&&i.jsx(yt,{time:r,isActive:n,showTenths:r<10,lowTimeThreshold:30,size:s==="horizontal"?"medium":"small"})]});return d?l:i.jsx(cl,{$isActive:n,$orientation:s,$compact:c,children:l})});st.displayName="PlayerCard";const pl=h.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  background-color: ${e=>e.theme.colors.surface};
...
`,Ho=X(({className:e,hasChat:t=!1,chatWidth:r=0})=>{const n=Ot(),o=De(),s=Ft(),a=zn(),d=Jo();Ne();const[c,l]=u.useState(!1),[p,m]=u.useState(!1),[g,f]=u.useState(0),[$,y]=u.useState(!1),[v,x]=u.useState(!1),[j,k]=u.useState(null),P=o.preferences.chessOrientation==="landscape",b=n.currentPosition||"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",R=window.innerWidth/window.innerHeight>1.6,A=u.useMemo(()=>!n.currentGame||n.currentGame.gameId<0?"freestyle":n.isPlaying?"playing":n.isObserving?"observing":n.isExamining?"examining":"observing",[n.currentGame,n.gameRelation]),O=u.useMemo(()=>n.currentGame?.variant==="crazyhouse"?!0:o.preferences.showCapturedPieces,[n.currentGame?.variant,o.preferences.showCapturedPieces]),H=u.useCallback((D,ie,Q)=>{try{n.makeMove(D,ie,Q)||(console.error("Invalid move:",D,ie),d.playIllegal())}catch(ue){console.error("Error making move:",ue),d.playIllegal()}},[n,d]),w=u.useCallback((D,ie)=>{try{const Q=D.toLowerCase();n.makeSANMove(`${D.toUpperCase()}@${ie}`)||(console.error("Invalid drop:",D,ie),d.playIllegal())}catch(Q){console.error("Error making drop:",Q),d.playIllegal()}},[n,d]),F=u.useCallback(D=>{k(j===D?null:D)},[j]);u.useMemo(()=>{if(n.currentGameInfo){const{white:D,black:ie,timeControl:Q,variant:ue}=n.currentGameInfo;return`Game ${n.currentGame?.gameId||"?"} • ${ue} ${Q}`}return"No active game"},[n.currentGameInfo,n.currentGame]);const B=(()=>{const D=n.moveHistory.length;if(D>0){const ie=n.moveHistory[D-1],Q=Math.ceil(D/2),ue=D%2===1,nt=cr(ie.san);return`${Q}.${ue?"":".."} ${nt}`}return"Starting position"})(),I=n.currentOpening,G=n.currentGame,ee=G||n.lastGameState,ce=ee?.white||{name:"White",rating:1500,time:900},Se=ee?.black||{name:"Black",rating:1500,time:900},q=!G||G.turn==="w",se=n.shouldShowFlippedBoard,ae=se?ce:Se,te=se?Se:ce,me=se,de=A==="freestyle"?!1:se?q:!q,Ce=u.useCallback(D=>{n.goToMove(D)},[n]);u.useEffect(()=>{s.initialize()},[s]),u.useEffect(()=>{v&&n.isPlaying&&n.currentGame&&a.sendCommand("draw")},[n.moveHistory.length,v,n.isPlaying,a]),u.useEffect(()=>{(!n.currentGame||!n.isPlaying)&&x(!1)},[n.currentGame,n.isPlaying]),u.useEffect(()=>{c&&s.isEngineReady?s.startAnalysis(b):s.stopAnalysis()},[c,b,s]);const fe=u.useCallback(()=>{l(D=>!D)},[]),C=u.useCallback(()=>{m(!0)},[]),L=u.useCallback(()=>{o.updatePreference("boardFlipped",!o.preferences.boardFlipped)},[o]),z=u.useCallback(()=>{n.currentGame&&a.sendCommand(`unobs ${n.currentGame.gameId}`)},[a,n.currentGame]),T=u.useCallback(()=>{a.sendCommand("unexamine")},[a]),E=u.useCallback(()=>{y(!0)},[]),M=u.useCallback(()=>{a.sendCommand("resign"),y(!1)},[a]),U=u.useCallback(()=>{a.sendCommand("draw"),x(!v)},[a,v]),re=u.useCallback(()=>{a.sendCommand("abort")},[a]),le=()=>i.jsxs(i.Fragment,{children:[i.jsx(wn,{$orientation:"portrait",children:i.jsx(td,{children:i.jsxs(rd,{children:[c&&i.jsx(md,{$boardSize:g,children:i.jsx(vr,{orientation:"vertical",boardSize:g})}),i.jsx(nd,{children:i.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center"},id:"board-container",children:[i.jsxs(Jl,{children:[i.jsxs(kn,{children:["Game #",ee?.gameId||"?"]}),i.jsx(Sn,{children:ee?.timeControl||"?"}),i.jsxs(Zl,{children:[A==="playing"&&i.jsxs(i.Fragment,{children:[n.moveHistory.length<=1&&i.jsx(be,{onClick:re,$variant:"secondary",children:"Abort"}),i.jsx(be,{onClick:U,$variant:"secondary",children:"Draw"}),i.jsx(be,{onClick:E,$variant:"secondary",children:"Resign"}),i.jsx(Dr,{color:n.playingColor||"white",size:"small"})]}),A==="observing"&&i.jsxs(i.Fragment,{children:[i.jsx(be,{onClick:z,$variant:"secondary",children:"Unobserve"}),i.jsx(be,{onClick:fe,$variant:"secondary",children:"Analysis"})]}),A==="examining"&&i.jsxs(i.Fragment,{children:[i.jsx(be,{onClick:T,$variant:"secondary",children:"Unexamine"}),i.jsx(be,{onClick:fe,$variant:"secondary",children:"Analysis"})]}),A==="freestyle"&&i.jsxs(i.Fragment,{children:[i.jsx(be,{onClick:fe,$variant:"secondary",children:"Analysis"}),i.jsx(be,{onClick:L,$variant:"secondary",children:"Flip"}),i.jsx(be,{onClick:C,$variant:"secondary",children:"FEN"})]})]})]}),i.jsxs(Rn,{children:[i.jsx(at,{player:ae,isActive:de,size:"small",compact:!0}),i.jsx(En,{children:i.jsx(st,{name:ae.name,rating:ae.rating,time:0,isActive:de,isWhite:me,orientation:"horizontal",hideClockInCard:!0,compact:!0})})]}),i.jsx(Pn,{$orientation:"portrait",children:i.jsx($r,{position:b,flipped:se,showCoordinates:o.preferences.showCoordinates,onMove:H,onDrop:w,interactive:A==="playing"||A==="freestyle"||A==="examining",lastMove:n.lastMove||void 0,onSizeCalculated:f,selectedCapturedPiece:j,onCapturedPieceSelect:k})}),i.jsxs(Rn,{children:[i.jsx(at,{player:te,isActive:A==="freestyle"?!1:!de,size:"small",compact:!0}),i.jsx(En,{children:i.jsx(st,{name:te.name,rating:te.rating,time:0,isActive:A==="freestyle"?!1:!de,isWhite:!me,orientation:"horizontal",hideClockInCard:!0,compact:!0})})]}),i.jsxs(ed,{children:[i.jsx(Cn,{children:n.premove?`Premove: ${Nr(`${n.premove.from}${n.premove.to}${n.premove.promotion||""}`,b)}`:B!=="Starting position"?`Last move: ${B}`:"Last move: none"}),I&&i.jsx(jn,{children:I})]}),c&&i.jsx(pd,{children:i.jsx(wr,{})})]})}),O&&i.jsx(ql,{$squareSize:g?g/8:0,children:i.jsxs(Kl,{$squareSize:g?g/8:0,children:[i.jsx(ct,{orientation:"vertical",isWhitePieces:se,boardSize:g,onPieceClick:F}),i.jsx(ct,{orientation:"vertical",isWhitePieces:!se,boardSize:g,onPieceClick:F})]})})]})})}),i.jsx(od,{$orientation:"portrait",$boardSize:g,children:i.jsx(qt,{moves:n.moveHistory,currentMoveIndex:n.currentMoveIndex,onMoveClick:Ce,disableAutoScroll:!0,onNavigate:D=>{if(n.isExamining)switch(D){case"first":a.sendCommand("back 500");break;case"prev":a.sendCommand("back");break;case"next":a.sendCommand("forward");break;case"last":a.sendCommand("forward 500");break}else switch(D){case"first":n.goToStart();break;case"prev":n.goToPreviousMove();break;case"next":n.goToNextMove();break;case"last":n.goToEnd();break}}})})]});return i.jsxs(Ul,{className:e,$orientation:P?"landscape":"portrait",$hasChat:t,children:[P?i.jsx(i.Fragment,{children:i.jsx(wn,{$orientation:"landscape",children:i.jsxs(id,{children:[i.jsx(ud,{children:c&&i.jsx(hd,{$boardSize:g,children:i.jsx(vr,{orientation:"vertical",boardSize:g})})}),i.jsxs(sd,{$hasAnalysis:c,children:[i.jsxs(Yl,{$isWideAspect:R,children:[i.jsxs(Xl,{$chatWidth:r,$hasAnalysis:c,children:[i.jsxs(kn,{children:["Game #",ee?.gameId||"?"]}),i.jsx(Sn,{children:ee?.timeControl||"?"})]}),i.jsx(Vl,{$orientation:"landscape",children:i.jsx(Pn,{$orientation:"landscape",$chatWidth:r,$hasAnalysis:c,children:i.jsx($r,{position:b,flipped:se,showCoordinates:o.preferences.showCoordinates,onMove:H,onDrop:w,interactive:A==="playing"||A==="freestyle"||A==="examining",lastMove:n.lastMove||void 0,onSizeCalculated:f,selectedCapturedPiece:j,onCapturedPieceSelect:k})})}),i.jsxs(Ql,{$chatWidth:r,$hasAnalysis:c,children:[i.jsx(Cn,{children:n.premove?`Premove: ${Nr(`${n.premove.from}${n.premove.to}${n.premove.promotion||""}`,b)}`:B!=="Starting position"?`Last move: ${B}`:"Last move: none"}),I&&i.jsx(jn,{children:I})]}),c&&i.jsx(dd,{$chatWidth:r,$hasAnalysis:c,children:i.jsx(wr,{})})]}),i.jsxs(ad,{$isWideAspect:R,$boardSize:g,children:[O&&i.jsx(ct,{orientation:"horizontal",isWhitePieces:me,boardSize:g,onPieceClick:F}),i.jsx(at,{player:ae,isActive:de,size:"small",compact:!0,variant:"landscape"}),i.jsxs(cd,{children:[i.jsx(st,{name:ae.name,rating:ae.rating,time:0,isActive:de,isWhite:me,orientation:"vertical",hideClockInCard:!0,compact:!0}),i.jsx(Do,{perspective:A,canAbort:n.moveHistory.length<=1,onAnalysis:fe,onFlipBoard:L,onSetupFEN:C,onUnobserve:z,onUnexamine:T,onResign:E,onDraw:U,onAbort:re,isAnalysisActive:c,isDrawOffered:v}),i.jsx(ld,{moves:n.moveHistory,currentMoveIndex:n.currentMoveIndex,onMoveClick:Ce,showHeader:!1,onNavigate:D=>{if(n.isExamining)switch(D){case"first":a.sendCommand("backward 999");break;case"prev":a.sendCommand("backward");break;case"next":a.sendCommand("forward");break;case"last":a.sendCommand("forward 999");break}else switch(D){case"first":n.goToStart();break;case"prev":n.goToPreviousMove();break;case"next":n.goToNextMove();break;case"last":n.goToEnd();break}}}),i.jsx(st,{name:te.name,rating:te.rating,time:0,isActive:!de,isWhite:!me,orientation:"vertical",hideClockInCard:!0,compact:!0})]}),i.jsx(at,{player:te,isActive:A==="freestyle"?!1:!de,size:"small",compact:!0,variant:"landscape"}),O&&i.jsx(ct,{orientation:"horizontal",isWhitePieces:!me,boardSize:g,onPieceClick:F})]})]})]})})}):le(),i.jsx(Fo,{isOpen:p,onClose:()=>m(!1)}),i.jsx(Gl,{isOpen:$,title:"Resign Game",message:"Are you sure you want to resign?",confirmText:"Yes, Resign",cancelText:"Cancel",onConfirm:M,onCancel:()=>y(!1)})]})});Ho.displayName="ChessGameLayout";const fd=h.div`
  display: flex;
  background-color: ${e=>e.theme.colors.surface};
  border-bottom: 1px solid ${e=>e.theme.colors.border};
  overflow-x: auto;
...
`,Uo=X(({content:e,ansiColors:t=!0,elements:r=[]})=>{const{ficsStore:n,preferencesStore:o}=Ee(),s=o.getChatAppearance(),[a,d]=u.useState(null),c=e.startsWith(`
`)?e.substring(1):e,l=g=>{if(!t)return g;const f={30:"#000000",31:"#CC0000",32:"#4E9A06",33:"#C4A000",34:"#3465A4",35:"#75507B",36:"#06989A",37:"#D3D7CF",90:"#555753",91:"#EF2929",92:"#8AE234",93:"#FCE94F",94:"#729FCF",95:"#AD7FA8",96:"#34E2E2",97:"#EEEEEC"};return g.replace(/\x1b\[(\d+)m/g,($,y)=>{const v=f[y];return v?`<span style="color: ${v}">`:y==="0"?"</span>":""})},p=g=>{const f=[];if(g.match(/^\w+(?:\([^)]*\))*\s*tells\s+you:|^\s*\w+(?:\([^)]*\))*\((\d+)\):/m)){const y=/(https?:\/\/[^\s]+)\s*$/gm;let v;for(;(v=y.exec(g))!==null;){const x=v[1],j=v.index,k=v.index+v[0].length,P=g.substring(k).match(/^\n\s+([^\s]+)/);if(P&&P[1].match(/[.\/\-?=&]/)){const b=x+P[1],S=k+P[0].length;f.push({start:j,end:S,url:b})}}}return f},m=g=>{const f=l(g),$=p(e),y=[{regex:/(https?:\/\/[^\s]+)/g,handler:(b,S)=>{const R=b[0],A=S||R;return i.jsx(Oe,{href:A,target:"_blank",rel:"noopener noreferrer",onClick:O=>{O.preventDefault(),window.open(A,"_blank")},children:R})}},{regex:/^(\w+) tells you:/gm,handler:b=>{const S=b[1];return i.jsxs("span",{children:[i.jsx(Oe,{onClick:R=>{R.preventDefault(),R.stopPropagation(),d({playerName:S,x:R.clientX,y:R.clientY})},children:S}),b[0].substring(S.length)]},`player-${S}`)}},{regex:/\bGame (\d+)\b/g,handler:b=>i.jsx(Oe,{onClick:S=>{S.preventDefault(),n.sendCommand(`observe ${b[1]}`)},children:b[0]})}];if(t&&f!==g)return i.jsx("span",{dangerouslySetInnerHTML:{__html:f}});let v=0;const x=[],j=[],k=[];return r.forEach(b=>{const S=c!==e?b.start-1:b.start;if(S>=0&&S<g.length){const R=b.type==="command"&&b.text.includes(":")&&(b.text.match(/^\s*\d+\s+/)||b.text.match(/^%\d+:/)||b.text.match(/^\d+:/)),A=(()=>{const O=(()=>{switch(b.type){case"command":return i.jsx(Oe,{onClick:H=>{H.preventDefault(),n.sendCommand(b.action||b.value)},children:b.text});case"player":return i.jsx(Oe,{onClick:H=>{H.preventDefault(),H.stopPropagation(),d({playerName:b.text,x:H.clientX,y:H.clientY})},children:b.text});case"gameNumber":return i.jsx(Oe,{onClick:H=>{H.preventDefault(),n.sendCommand(`observe ${b.value}`)},children:b.text});default:return b.text}})();return R?i.jsx(Cd,{children:O}):O})();k.push({start:S,end:S+b.text.length,render:A,priority:20})}}),$.forEach(b=>{const S=g.substring(b.start).match(/^(https?:\/\/[^\s]+)/);if(S){const R=S[1];k.push({start:b.start,end:b.start+R.length,render:i.jsx(Oe,{href:b.url,target:"_blank",rel:"noopener noreferrer",onClick:A=>{A.preventDefault(),window.open(b.url,"_blank")},children:R}),priority:10}),j.push([b.start,b.end])}}),y.forEach(b=>{const S=new RegExp(b.regex);let R;for(;(R=S.exec(g))!==null;){const A=R.index,O=A+R[0].length;j.some(([w,F])=>A>=w&&A<F||O>w&&O<=F)||k.push({start:A,end:O,render:b.handler(R),priority:1})}}),k.sort((b,S)=>b.start!==S.start?b.start-S.start:S.priority-b.priority),k.filter((b,S)=>{if(S===0)return!0;const R=k[S-1];return b.start>=R.end}).forEach((b,S)=>{b.start>v&&x.push(g.substring(v,b.start)),x.push(i.jsx(Z.Fragment,{children:b.render},S)),v=b.end}),v<g.length&&x.push(g.substring(v)),x.length>0?x:g};return i.jsxs(i.Fragment,{children:[i.jsx(Sd,{$fontSize:s.fontSize,children:m(c)}),a&&i.jsx(Ar,{playerName:a.playerName,position:{x:a.x,y:a.y},onClose:()=>d(null)})]})}),jd=h.div`
  margin: 0;
`;class Pd extends Go{constructor(){super(...arguments),this.type="default"}canRender(){return!0}render({message:t}){const r=t.metadata?.parsedMessage?.elements;return i.jsx(jd,{children:i.jsx(Uo,{content:t.content,elements:r})})}}class Y extends Go{render({message:t}){const r=t.metadata?.parsedMessage?.elements;return i.jsx(Uo,{content:t.content,elements:r})}}class Rd extends Y{constructor(){super(...arguments),this.type="shout"}}class Ed extends Y{constructor(){super(...arguments),this.type="cshout"}}class Md extends Y{constructor(){super(...arguments),this.type="notification"}}class zd extends Y{constructor(){super(...arguments),this.type="seekAnnouncement"}}class Td extends Y{constructor(){super(...arguments),this.type="matchRequest"}}class Ld extends Y{constructor(){super(...arguments),this.type="illegalMove"}}class Id extends Y{constructor(){super(...arguments),this.type="drawOffer"}}class Ad extends Y{constructor(){super(...arguments),this.type="unobserve"}}class Dd extends Y{constructor(){super(...arguments),this.type="gameNotification"}}class Nd extends Y{constructor(){super(...arguments),this.type="whoOutput"}}class Od extends Y{constructor(){super(...arguments),this.type="gamesOutput"}}class Fd extends Y{constructor(){super(...arguments),this.type="fingerOutput"}}class Bd extends Y{constructor(){super(...arguments),this.type="historyOutput"}}class Wd extends Y{constructor(){super(...arguments),this.type="journalOutput"}}class Hd extends Y{constructor(){super(...arguments),this.type="soughtOutput"}}class _d extends Y{constructor(){super(...arguments),this.type="channelListOutput"}}class Gd extends Y{constructor(){super(...arguments),this.type="newsOutput"}}class Ud extends Y{constructor(){super(...arguments),this.type="inOutput"}}class Yd extends Y{constructor(){super(...arguments),this.type="login"}}class Vd extends Y{constructor(){super(...arguments),this.type="password"}}class qd extends Y{constructor(){super(...arguments),this.type="guestLoginConfirmation"}}class Kd extends Y{constructor(){super(...arguments),this.type="sessionStart"}}class Xd extends Y{constructor(){super(...arguments),this.type="system"}}class Qd extends Y{constructor(){super(...arguments),this.type="raw"}}class Jd extends Y{constructor(){super(...arguments),this.type="gameEnd"}}class Zd extends Y{constructor(){super(...arguments),this.type="gameStart"}}function eu(){W.clear(),W.register(new Rd),W.register(new Ed),W.register(new Md),W.register(new zd),W.register(new Td),W.register(new Ld),W.register(new Id),W.register(new Ad),W.register(new Dd),W.register(new Nd),W.register(new Od),W.register(new Fd),W.register(new Bd),W.register(new Wd),W.register(new Hd),W.register(new _d),W.register(new Gd),W.register(new Ud),W.register(new Yd),W.register(new Vd),W.register(new qd),W.register(new Kd),W.register(new Xd),W.register(new Qd),W.register(new Jd),W.register(new Zd),W.register(new Pd)}eu();const lt=X(({message:e,currentUsername:t,onCommandClick:r,onHover:n})=>{const{preferencesStore:o}=Ee(),s=e.metadata?.consoleType,a=e.metadata?.channelNumber,d=s?o.getConsoleColor(s,a):null,c=s?o.getConsoleFont(s,a):null,l=s?o.getConsoleFontStyle(s,a):null,p={...e,metadata:{...e.metadata,color:d,fontFamily:c,fontStyle:l}},m=W.getRenderer(p);return m?i.jsx("div",{onMouseEnter:()=>n?.(e.timestamp),onMouseLeave:()=>n?.(null),children:m.render({message:p,currentUsername:t,onCommandClick:r,onHover:n})}):(console.warn("No renderer found for message:",e),i.jsx("div",{children:e.content}))});lt.displayName="Message";const kt=h.div`
  flex: 1;
  background-color: ${e=>e.theme.colors.background};
  border-radius: ${e=>e.theme.borderRadius.container};
...
`,Vo=({value:e,onChange:t,onSend:r,onHistoryNavigate:n,placeholder:o="Type a message...",disabled:s=!1})=>{const a=u.useRef(null),d=l=>{l.key==="Enter"&&!l.shiftKey?(l.preventDefault(),e&&r(e)):l.key==="ArrowUp"&&!e?(l.preventDefault(),n?.("up")):l.key==="ArrowDown"&&(l.preventDefault(),n?.("down"))},c=()=>{e&&r(e)};return i.jsxs(nu,{children:[i.jsx(ou,{ref:a,value:e,onChange:l=>t(l.target.value),onKeyDown:d,placeholder:o,disabled:s,autoComplete:"off",spellCheck:"true",rows:1}),i.jsx(iu,{onClick:c,disabled:s||!e,title:"Send message (Enter)",children:"Send"})]})};Vo.displayName="ChatInput";const su=h.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  background-color: ${e=>e.theme.colors.surface};
...
`,yu=()=>i.jsx(Zo,{children:i.jsxs(_a,{children:[i.jsx(xu,{}),i.jsx(Cs,{children:i.jsx(ts,{children:i.jsx(Gn,{path:"/",element:i.jsx(ec,{children:i.jsx(Ko,{})})})})})]})}),Xo=document.getElementById("root");if(!Xo)throw new Error("Root element not found");const bu=Tn(Xo);bu.render(i.jsx(yu,{}));
